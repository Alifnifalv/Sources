...
namespace Eduegate.Domain.Entity.Models.Mapping
{
    public class ScreenMetadataMap : EntityTypeConfiguration<ScreenMetadata>
    {
        public ScreenMetadataMap()
        {
            ...
            this.Property(t => t.ScreenTypeID);
            ...
            this.Property(t => t.IsGenericCRUDSave).HasColumnName("IsGenericCRUDSave");
            this.Property(t => t.EntityMapperViewModel).HasColumnName("EntityMapperViewModel");
            this.Property(t => t.EntityMapperAssembly).HasColumnName("EntityMapperAssembly");
            this.Property(t => t.ModelAssembly).HasColumnName("ModelAssembly");
            this.Property(t => t.EntityType).HasColumnName("EntityType");
            this.Property(t => t.PrintPreviewReportName).HasColumnName("PrintPreviewReportName");
            // Relationships
