...
namespace Eduegate.Domain.Entity.Models.Mapping
{
    public class ShoppingCartItemMap : EntityTypeConfiguration<ShoppingCartItem>
    {
        public ShoppingCartItemMap()
        {
            ...
            this.Property(t => t.ProductPrice).HasColumnName("ProductPrice").HasPrecision(18,3);
            this.Property(t => t.ProductDiscountPrice).HasColumnName("ProductDiscountPrice").HasPrecision(18, 3);
            this.Property(t => t.DeliveryDays).HasColumnName("DeliveryDays");
            this.Property(t => t.NetWeight).HasColumnName("NetWeight").HasPrecision(18, 3);
