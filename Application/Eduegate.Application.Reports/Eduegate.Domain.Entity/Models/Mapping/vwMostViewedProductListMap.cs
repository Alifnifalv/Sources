...
{
    public class vwMostViewedProductListMap : EntityTypeConfiguration<vwMostViewedProductList>
    {
        public vwMostViewedProductListMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductCode, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.ProductColor, t.BrandID, t.BrandCode, t.BrandPosition, t.ProductAvailableQuantity, t.ProductDescription, t.ProductDetails });
            ...
            this.ToTable("vwMostViewedProductList");
            ...
            this.Property(t => t.NumView).HasColumnName("NumView");
        }
    }
}
