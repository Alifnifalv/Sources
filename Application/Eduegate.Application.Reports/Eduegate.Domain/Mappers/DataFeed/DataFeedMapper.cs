    ...
    public class DataFeedMapper
    {
        ...
        public DataFeedLogDTO ToDataFeedLogDTO(DataFeedLog dataFeedLog)
        {
            DataFeedLogDTO dataFeedLogDTO = new DataFeedLogDTO()
            {
                ...
                DataFeedTypeID = dataFeedLog.DataFeedTypeID.HasValue ? dataFeedLog.DataFeedTypeID.Value : 0,
                ...
                DataFeedTypeName = dataFeedLog.DataFeedType.Name,
                DataFeedStatusName = dataFeedLog.DataFeedStatus.StatusName,
