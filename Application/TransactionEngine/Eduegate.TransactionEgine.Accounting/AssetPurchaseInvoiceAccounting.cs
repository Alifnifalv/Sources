...
{
    public class AssetPurchaseInvoiceAccounting : AccountingBase, IAssetTransactions
    {
        private Action<string> _logError;
        private CallContext _callContext;

        public AssetPurchaseInvoiceAccounting(Action<string> logError, CallContext context = null)
        {
            _logError = logError;
        ...
        {
            WriteLog("AssetEntryPurchase-AccountingProcess started for TransactionID:" + transaction.HeadIID.ToString());
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog("Exception occured in AssetPurchaseInvoiceAccounting-Process.:" + ex.Message, ex);
            }
        }
