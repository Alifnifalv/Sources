...
{
    public class PurchaseReturnAccounting : AccountingBase, ITransactions
    {
        private Action<string> _logError;

        public PurchaseReturnAccounting(Action<string> logError)
        {
            _logError = logError;
        }
        ...
        {
            get { return Framework.Enums.DocumentReferenceTypes.PurchaseReturn; }
        }
        ...
        {
            WriteLog("PurchaseReturnAccounting-AccountingProcess started for TransactionID:" + transaction.HeadIID.ToString());

            try
            {
                long transactionHeadIID = transaction.HeadIID;
                string Description = "PurchaseReturnAccounting: Transaction-" + transactionHeadIID.ToString() + " ";
            ...
            catch (Exception ex)
            {
                ...
                WriteLog("Exception occured in PurchaseReturnAccounting-Process.:" + ex.Message, ex);
            }
        }
