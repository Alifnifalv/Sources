...
$client = "eduegate"        # Predefined client, e.g., "pearl" or "eduegate"
$environment = "live"  # Predefined environment, e.g., "staging" or "live"
...
foreach ($appConfig in $appConfigs) {
	...
	# Set sourceIconPath based on client and appType
