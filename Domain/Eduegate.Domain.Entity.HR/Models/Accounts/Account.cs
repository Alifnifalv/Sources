namespace Eduegate.Domain.Entity.HR.Models
{
    ...
    public partial class Account
    {
        ...
        public Account()
        {
            ...
            SalaryComponentExpenseLedgerAccounts = new HashSet<SalaryComponent>();
            SalaryComponentProvisionLedgerAccounts = new HashSet<SalaryComponent>();
            SalaryComponentStaffLedgerAccounts = new HashSet<SalaryComponent>();
            EmployeeDepartmentAccountMapExpenseLedgerAccounts = new HashSet<EmployeeDepartmentAccountMap>();
            EmployeeDepartmentAccountMapProvisionLedgerAccounts = new HashSet<EmployeeDepartmentAccountMap>();
            EmployeeDepartmentAccountMapStaffLedgerAccounts = new HashSet<EmployeeDepartmentAccountMap>();
            EmployeeDepartmentAccountMapTaxLedgerAccounts = new HashSet<EmployeeDepartmentAccountMap>();
        }
        [Key]
        ...
        public virtual ICollection<SalaryComponent> SalaryComponentExpenseLedgerAccounts { get; set; }
        
        public virtual ICollection<SalaryComponent> SalaryComponentProvisionLedgerAccounts { get; set; }
        
        public virtual ICollection<SalaryComponent> SalaryComponentStaffLedgerAccounts { get; set; }
        public virtual ICollection<EmployeePromotion> EmployeePromotions { get; set; }

        [InverseProperty("ExpenseLedgerAccount")]
        public virtual ICollection<EmployeeDepartmentAccountMap> EmployeeDepartmentAccountMapExpenseLedgerAccounts { get; set; }
        [InverseProperty("ProvisionLedgerAccount")]
        public virtual ICollection<EmployeeDepartmentAccountMap> EmployeeDepartmentAccountMapProvisionLedgerAccounts { get; set; }
        [InverseProperty("StaffLedgerAccount")]
        public virtual ICollection<EmployeeDepartmentAccountMap> EmployeeDepartmentAccountMapStaffLedgerAccounts { get; set; }
        [InverseProperty("TaxLedgerAccount")]
        public virtual ICollection<EmployeeDepartmentAccountMap> EmployeeDepartmentAccountMapTaxLedgerAccounts { get; set; }
