...
{
    public partial class dbEduegateLmsContext : DbContext
    {
        public dbEduegateLmsContext()
        {
        }

        public dbEduegateLmsContext(DbContextOptions<dbEduegateLmsContext> options) : base(options)
        {
        }
