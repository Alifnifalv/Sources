namespace Eduegate.Domain.Entity.School.Models
{
    ...
    public partial class LessonPlan
    {
        ...
        public LessonPlan()
        {
            ...
            LessonPlanSkillDevelopmentMaps = new HashSet<LessonPlanSkillDevelopmentMap>();
            LessonPlanTeachingMethodologyMaps = new HashSet<LessonPlanTeachingMethodologyMap>();
            LessonPlanAssessmentMaps = new HashSet<LessonPlanAssessmentMap>();
        }
        ...
        public virtual SubjectUnit Unit { get; set; }
        ...
        public virtual ICollection<LessonPlanSkillDevelopmentMap> LessonPlanSkillDevelopmentMaps { get; set; }

        public virtual ICollection<LessonPlanClassSectionMap> LessonPlanClassSectionMaps { get; set; }
        public virtual ICollection<LessonPlanTeachingMethodologyMap> LessonPlanTeachingMethodologyMaps { get; set; }
        public virtual ICollection<LessonPlanAssessmentMap> LessonPlanAssessmentMaps { get; set; }
