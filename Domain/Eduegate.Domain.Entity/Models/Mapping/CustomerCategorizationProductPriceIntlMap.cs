...
{
    public class CustomerCategorizationProductPriceIntlMap : EntityTypeConfiguration<CustomerCategorizationProductPriceIntl>
    {
        public CustomerCategorizationProductPriceIntlMap()
        {
            // Primary Key
            ...
            this.ToTable("CustomerCategorizationProductPriceIntl");
