...
{
    public class vwCategoryListMap : EntityTypeConfiguration<vwCategoryList>
    {
        public vwCategoryListMap()
        {
            // Primary Key
            this.HasKey(t => new { t.CategoryID, t.ParentID, t.CategoryCode, t.CategoryNameEn, t.CategoryPosition, t.CategoryLevel, t.CategoryBreadCrumbs, t.CategoryActive, t.CategoryNameAr });
            ...
            this.Property(t => t.CategoryPosition)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.SubCategoryCount).HasColumnName("SubCategoryCount");
