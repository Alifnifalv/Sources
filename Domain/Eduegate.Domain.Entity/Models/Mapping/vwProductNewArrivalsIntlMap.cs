...
{
    public class vwProductNewArrivalsIntlMap : EntityTypeConfiguration<vwProductNewArrivalsIntl>
    {
        public vwProductNewArrivalsIntlMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.DeliveryDays, t.NewArrival, t.BrandCode, t.ProductCreatedOn, t.BrandID, t.BrandPosition, t.ProductAvailableQuantity, t.ProductNameBrand, t.ProductActive, t.ProductActiveAr, t.RefCountryID });
            ...
            this.ToTable("vwProductNewArrivalsIntl");
