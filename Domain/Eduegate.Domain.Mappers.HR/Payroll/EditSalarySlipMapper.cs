        ...
        public override string GetEntity(long IID)
        {
            ...
            {               
                ...
                var editsalaryslip = new SalarySlipDTO()
                {
                    ...
                    EmployeeName = entity.EmployeeID.HasValue ? entity.Employee?.EmployeeCode + " - " + entity.Employee.FirstName + " " + entity.Employee.MiddleName + " " + entity.Employee.LastName : string.Empty,
