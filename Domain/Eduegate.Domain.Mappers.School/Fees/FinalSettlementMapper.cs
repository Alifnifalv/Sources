...
namespace Eduegate.Domain.Mappers.School.Fees
{
    public class FinalSettlementMapper : DTOEntityDynamicMapper
    {
        ...
        public override string GetEntity(long IID)
        {
            ...
            using (var dbContext = new dbEduegateSchoolContext())
            {
                ...
                feeDueDTO = new FinalSettlementDTO()
                {
                    ...
                    CollectionDate = finalData.CreatedDate,
                    SettlementDate = finalData.FinalSettlementDate,
                };
        ...
        public override string SaveEntity(BaseMasterDTO dto)
        {
            ...
            if (monthlyClosingDate.HasValue && monthlyClosingDate.Value.Year > 1900 && toDto.SettlementDate.Value.Date <= monthlyClosingDate.Value.Date)
            {
