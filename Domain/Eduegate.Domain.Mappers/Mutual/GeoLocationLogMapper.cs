            ...
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                if (studentDet != null)
                {
                    ...
                    if (transportDet != null)
                    {
                        ...
                        //var assign = vehicleMap != null ? dbContext.AssignVehicleMaps.FirstOrDefault(d => d.VehicleID == vehicleMap.VehicleID) : null;
                        var assign = route != null ? dbContext.AssignVehicleMaps.AsNoTracking().FirstOrDefault(d => d.RouteID == route.RouteID && d.AcademicYear.AcademicYearStatusID == currentAcademicYearStatusID   && d.IsActive == true) : null;
