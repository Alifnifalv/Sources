    ...
    public class EmailNotificationBL
    {
        ...
        public void SendMail(string toEmailID, string subject, string msgContent, EmailTypes typeName, Dictionary<string, string> parameters, List<string> ccMailIDs = null)
        {
            try
            {
                ...
                var mailHost = new SettingBL(_context).GetSettingValue<string>("EMAILHOST_" + typeName.ToString().ToUpper());
                mailHost = string.IsNullOrEmpty(mailHost) ? new SettingBL(_context).GetSettingValue<string>("EMAILHOST") : mailHost;

                var mailPortNumber = new SettingBL(_context).GetSettingValue<string>("SMTPPORT_" + typeName.ToString().ToUpper());
                mailPortNumber = string.IsNullOrEmpty(mailPortNumber) ? new SettingBL(_context).GetSettingValue<string>("SMTPPORT") : mailPortNumber;

                var SMTPUserName = new SettingBL(_context).GetSettingValue<string>("SMTPUSERNAME_" + typeName.ToString().ToUpper());
                SMTPUserName = string.IsNullOrEmpty(SMTPUserName) ? new SettingBL(_context).GetSettingValue<string>("SMTPUSERNAME") : SMTPUserName;
                SMTPUserName = ResolveEmailVariable(SMTPUserName, parameters);

                var SMTPPassword = new SettingBL(_context).GetSettingValue<string>("SMTPPASSWORD_" + typeName.ToString().ToUpper());
                SMTPPassword = string.IsNullOrEmpty(SMTPPassword) ? new SettingBL(_context).GetSettingValue<string>("SMTPPASSWORD") : SMTPPassword;

                var fromEmail = new SettingBL(_context).GetSettingValue<string>("EMAILFROM_" + typeName.ToString().ToUpper());
                fromEmail = string.IsNullOrEmpty(fromEmail) ? new SettingBL(_context).GetSettingValue<string>("EMAILFROM") : fromEmail;
                fromEmail = ResolveEmailVariable(fromEmail, parameters);

                var mailName = new SettingBL(_context).GetSettingValue<string>("EMAILUSER_" + typeName.ToString().ToUpper());
                mailName = string.IsNullOrEmpty(mailName) ? new SettingBL(_context).GetSettingValue<string>("EMAILUSER") : mailName;

                var senderEmailID = new SettingBL(_context).GetSettingValue<string>("EMAILID_" + typeName.ToString().ToUpper());
                senderEmailID = string.IsNullOrEmpty(senderEmailID) ? new SettingBL(_context).GetSettingValue<string>("EMAILID") : senderEmailID;
                senderEmailID = ResolveEmailVariable(senderEmailID, parameters);

                var isEnableSecurityProtocol = new SettingBL(_context).GetSettingValue<bool>("ISENABLE_SECURITY_PROTOCOL");
        ...
        public OperationResultDTO SendMailNotification(MailNotificationDTO mailDTO)
        {
            ...
            try
            {
                var hostEmail = new SettingBL().GetSettingValue<string>("SMTPUSERNAME");
                var hostPassword = new SettingBL().GetSettingValue<string>("SMTPPASSWORD");
                var fromEmail = new SettingBL().GetSettingValue<string>("EMAILFROM");

                var hostUser = new SettingBL().GetSettingValue<string>("EMAILUSER");
                var clientHost = new SettingBL().GetSettingValue<string>("EMAILHOST");

                var documentPhysicalPath = new SettingBL().GetSettingValue<string>("DocumentsPhysicalPath");
        ...
        public string PopulateBody(string Name, string htmlMessage, string mailclosingRegard = null, string mailRegardName = null)
        {
            ...
            var settingBL = new SettingBL(_context);
        ...
        {
            var reportingService = new SettingBL(_context).GetSettingValue<string>("REPORTING_SERVICE", "eduegate");

            if (reportingService.ToLower() == "ssrs")
            {
                var reportServer = new SettingBL(_context).GetSettingValue<string>("ReportServer");
                var reportServerDirect = new SettingBL(_context).GetSettingValue<string>("ReportServerDirect");
                var reportDomainName = new SettingBL(_context).GetSettingValue<string>("ReportServerDomain");

                var reportUserName = new SettingBL(_context).GetSettingValue<string>("ReportServerDomainUser");
                var reportPassword = new SettingBL(_context).GetSettingValue<string>("ReportServerDomainPassword");
