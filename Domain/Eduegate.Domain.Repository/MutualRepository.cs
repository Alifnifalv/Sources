...
namespace Eduegate.Domain.Repository
{
    public class MutualRepository
    {
            ...
            using (var db = new dbEduegateERPContext())
            {
                ...
                else
                {
                    if (parentID.HasValue)
                    {
                        return db.AreaTreeSearches
                               .Where(x => x.ParentAreaID == parentID
                               && x.TreePath.Contains(searchText)).AsNoTracking().ToList();
                    }
                    else
                    {
                        return db.AreaTreeSearches
                               .Where(x => x.TreePath.Contains(searchText)).AsNoTracking().ToList();
                    }
                }
            }
        }
        ...
        public bool RemoveEntityTypeRelationMaps(EntityTypeRelationMap entity)
        {
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                List<EntityTypeRelationMap> deleteEntity = db.EntityTypeRelationMaps
                    ...
                    && x.FromRelationID == entity.FromRelationID).AsNoTracking().ToList();

                if (deleteEntity != null)
                {
                    //db.Entry(deleteEntity).State = EntityState.Deleted;
                ...
                using (dbEduegateERPContext dbContext = new dbEduegateERPContext())
                {
                    if (entityPropertyMaps.IsNotNull() && entityPropertyMaps.Count > 0)
                    {
                        foreach (EntityPropertyMap entityPropertyMap in entityPropertyMaps)
                        {
                            ...
                            {
                                EntityPropertyMap epm = dbContext.EntityPropertyMaps.Where(x => x.EntityPropertyMapIID == entityPropertyMap.EntityPropertyMapIID).AsNoTracking().FirstOrDefault();
        ...
        public List<EntityTypeEntitlement> GetEntityTypeEntitlementByEntityType(int entityType)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                List<EntityTypeEntitlement> entity = db.EntityTypeEntitlements.Where(x => x.EntityTypeID == entityType).AsNoTracking().ToList();
                return entity;
            }
        }
        ...
        public EntitlementMap SaveEntitlementMap(EntitlementMap entity)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                ...
                var entityExist = db.EntitlementMaps.Where(x => x.ReferenceID == entity.ReferenceID && x.EntitlementID == entity.EntitlementID).AsNoTracking().FirstOrDefault();
                if (entityExist != null)
                {
        ...
        public EntityTypePaymentMethodMap SaveEntityTypePaymentMethodMap(EntityTypePaymentMethodMap entity)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                ...
                {
                    // Update
                    var existEntity = db.EntityTypePaymentMethodMaps.Where(x => x.EntityTypePaymentMethodMapIID == entity.EntityTypePaymentMethodMapIID).AsNoTracking().FirstOrDefault();
        ...
        public List<EntityTypePaymentMethodMap> GetEntityTypePaymentMethodMapByReferenceID(EntityTypePaymentMethodMap entity)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.EntityTypePaymentMethodMaps.Where(x => x.ReferenceID == entity.ReferenceID).AsNoTracking().ToList();
            }
        }
        ...
        public bool DeleteEntityTypePaymentMethodMapByReferenceID(EntityTypePaymentMethodMap entity)
        {
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                var list = db.EntityTypePaymentMethodMaps.Where(x => x.ReferenceID == entity.ReferenceID).AsNoTracking().ToList();
        ...
        public City SaveCity(City city)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (city.CityID == 0)
                {
                    ...
                    city.CityID = Convert.ToInt32((cityID.HasValue ? cityID.Value : 0) + 1);
                }

                bool isBool = db.Cities.Where(x => x.CityID == city.CityID).AsNoTracking().Any();
                if (isBool)
                {
                    // Update
                ...
                {
                    // Insert
                    db.Entry(city).State = Microsoft.EntityFrameworkCore.EntityState.Added;
                }
                db.SaveChanges();
        ...
        public List<City> GetCities()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Cities.OrderBy(a => a.CityName).AsNoTracking().ToList();
            }
        }
        ...
        public Zone SaveZone(Zone zone)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                ...
                if (db.Zones.Where(x => x.ZoneID == zone.ZoneID).AsNoTracking().Any() == false) //Checking records exist or not from route table to create/update
                {
                    db.Entry(zone).State = Microsoft.EntityFrameworkCore.EntityState.Added;       // Insert
                }
                else
                {
                    db.Entry(zone).State = Microsoft.EntityFrameworkCore.EntityState.Modified;    // Update
                }
        ...
        public Zone GetZone(long zoneID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                var zone = db.Zones.Where(x => x.ZoneID == zoneID)
                    .Include(i => i.Country)
        ...
        public List<Zone> GetZones(int? companyID = 0)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Zones.Where(x => x.CompanyID == companyID).OrderBy(a => a.ZoneName).AsNoTracking().ToList();
            }
        }
        ...
        public Area SaveArea(Area area)
        {
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                ...
                if (db.Areas.Where(x => x.AreaID == area.AreaID)
                    .Include(i => i.Country)
                    .Include(i => i.City)
                    .AsNoTracking()
                    .Any() == false) //Checking records exist or not from area table to create/update
                {
                    db.Entry(area).State = Microsoft.EntityFrameworkCore.EntityState.Added;       // Insert
                }
                else
                {
                    db.Entry(area).State = Microsoft.EntityFrameworkCore.EntityState.Modified;    // Update
                }
        ...
        public Area GetArea(long areaID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                var area = db.Areas.Where(x => x.AreaID == areaID)
                    .Include(i => i.Country)
                    .Include(i => i.City)
                    .AsNoTracking()
                    .FirstOrDefault();
        ...
        public City GetCity(long cityID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Cities.Where(x => x.CityID == cityID).AsNoTracking().FirstOrDefault();
            }
        }
        ...
        public List<Area> GetAreas()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Areas.OrderBy(a => a.AreaName).AsNoTracking().ToList();
            }
        }
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (countryID.HasValue)
                {
                    return (from ar in db.Areas
                            ...
                            select ar).Distinct().OrderBy(a => a.AreaName).AsNoTracking().ToList();
                }
                else
                {
                    return (from ar in db.Areas
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (countryID.HasValue)
                {
                    return (from city in db.Cities
                            ...
                            select city).Distinct().OrderBy(x => x.CityName).AsNoTracking().ToList();
                }
                else
                {
                    return (from city in db.Cities
            ...
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (cityID.HasValue)
                {
                    return (from ar in db.Areas
                            ...
                            select ar).Distinct().OrderBy(x => x.AreaName).AsNoTracking().ToList();
                }
                else
                {
                    return (from ar in db.Areas
        ...
        public Vehicle SaveVehicle(Vehicle vehicle)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                ...
                {
                    // Insert
                    db.Entry(vehicle).State = Microsoft.EntityFrameworkCore.EntityState.Added;
                }
                db.SaveChanges();
        ...
        public Vehicle GetVehicle(long vehicleID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                var vehicle = db.Vehicles.Where(x => x.VehicleIID == vehicleID)
                    .Include(i => i.Country)
                    .Include(i => i.City)
                    .AsNoTracking()
                    .FirstOrDefault();
        ...
        public List<Vehicle> GetVehicles()
        {
            using (dbEduegateERPContext dbContext = new dbEduegateERPContext())
            {
                return dbContext.Vehicles.OrderBy(a => a.VehicleCode).AsNoTracking().ToList();
            }
        }
        ...
        public List<VehicleType> GetVehicleTypes()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.VehicleTypes.OrderBy(a => a.VehicleTypeName).AsNoTracking().ToList();
            }
        }
        ...
        public List<VehicleOwnershipType> GetVehicleOwnershipTypes()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.VehicleOwnershipTypes.OrderBy(a => a.OwnershipTypeName).AsNoTracking().ToList();
            }
        }
        ...
        public List<Basket> GetBaskets()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Basket.OrderBy(a => a.BasketCode).AsNoTracking().ToList();
            }
        }
        ...
        public List<Comment> GetComments(long entityTypeID, long referenceID, long departmentID = 0)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (departmentID > 0)
                {
                    return db.Comments.Where(c => c.EntityTypeID == entityTypeID && c.ReferenceID == referenceID && c.DepartmentID == departmentID).AsNoTracking().ToList();
                }
                else
                {
                    return db.Comments.Where(c => c.EntityTypeID == entityTypeID && c.ReferenceID == referenceID).OrderByDescending(x => x.CommentIID).AsNoTracking().ToList();
                }
            }
        }

        public List<Comment> GetChats(long entityTypeID, long? fromLoginID, long? toLoginID, int page, int pageSize, int studentID)
        {
            // Check for null parameters to prevent query issues
            if (!fromLoginID.HasValue || !toLoginID.HasValue)
            {
                throw new ArgumentNullException("Both fromLoginID and toLoginID must have values.");
            }

            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Comments
                    .Where(c => c.EntityTypeID == entityTypeID &&
                               ((c.FromLoginID == fromLoginID && c.ToLoginID == toLoginID) ||
                                (c.FromLoginID == toLoginID && c.ToLoginID == fromLoginID)) &&
                               (c.ReferenceID == studentID || c.ReferenceID == 0))// 👈 Ensures separation per student
                    .OrderByDescending(c => c.CreatedDate)  // Fetch recent messages first
        ...
        public List<Comment> GetCommentsByEntityType(long entityTypeID, long referenceID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Comments.Where(c => c.EntityTypeID == entityTypeID && c.ReferenceID == referenceID).AsNoTracking().ToList();
            }
        }
       ...
       on jed.JobEntryHeadID equals jeh.JobEntryHeadIID
        ...
        public Comment GetComment(long commentID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Comments.Where(c => c.CommentIID == commentID).AsNoTracking().FirstOrDefault();
            }
        }
        ...
        public List<Attachment> GetAttachments(long entityTypeID, long referenceID, long departmentID = 0)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                if (departmentID > 0)
                {
                    return db.Attachments.Where(c => c.EntityTypeID == entityTypeID && c.ReferenceID == referenceID && c.DepartmentID == departmentID)
                        .AsNoTracking()
                        .ToList();
                }
                else
                {
                    return db.Attachments.Where(c => c.EntityTypeID == entityTypeID && c.ReferenceID == referenceID)
                        .OrderByDescending(x => x.AttachmentIID)
                        .AsNoTracking()
                        .ToList();
                }
            }
        ...
        public bool SaveDeliveryCharges(List<ProductDeliveryTypeMap> pdtMaps, long IID, bool isProduct)
        {
            try
            {
                ...
                {
                    if (isProduct)
                        dbContext.ProductDeliveryTypeMaps.RemoveRange(dbContext.ProductDeliveryTypeMaps.Where(x => x.ProductID == IID).AsNoTracking());
                    else
                        dbContext.ProductDeliveryTypeMaps.RemoveRange(dbContext.ProductDeliveryTypeMaps.Where(x => x.ProductSKUMapID == IID).AsNoTracking());
        ...
        public bool SaveCustomerDeliveryCharges(List<CustomerGroupDeliveryTypeMap> cgdtMaps, int customerGroupID)
        {
            try
            {
                ...
                using (dbEduegateERPContext dbContext = new dbEduegateERPContext())
                {
                    dbContext.CustomerGroupDeliveryTypeMaps.RemoveRange(dbContext.CustomerGroupDeliveryTypeMaps.Where(x => x.CustomerGroupID == customerGroupID).AsNoTracking());
        ...
        public bool SaveZoneDeliveryCharges(List<DeliveryTypeAllowedZoneMap> dtamaps, short zoneID)
        {
            try
            {
                ...
                using (dbEduegateERPContext dbContext = new dbEduegateERPContext())
                {
                    dbContext.DeliveryTypeAllowedZoneMaps.RemoveRange(dbContext.DeliveryTypeAllowedZoneMaps.Where(x => x.ZoneID == zoneID).AsNoTracking());
        ...
        public bool SaveAreaDeliveryCharges(List<DeliveryTypeAllowedAreaMap> dtamaps, int areaID)
        {
            try
            {
                ...
                using (dbEduegateERPContext dbContext = new dbEduegateERPContext())
                {
                    dbContext.DeliveryTypeAllowedAreaMaps.RemoveRange(dbContext.DeliveryTypeAllowedAreaMaps.Where(x => x.AreaID == areaID).AsNoTracking());
        ...
        public List<ImageType> GetImageTypes()
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.ImageTypes.OrderBy(a => a.TypeName)
                    .AsNoTracking()
                    .ToList();
            }
        }
        ...
        public EntityTypeEntitlement GetEntitlementById(long id)
        {
            using (var db = new dbEduegateERPContext())
            {
                return db.EntityTypeEntitlements.Where(x => x.EntitlementID == id)
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        }
        ...
        public Area GetAreaById(int areaId)
        {
            using (var db = new dbEduegateERPContext())
            {
                return db.Areas.Where(x => x.AreaID == areaId)
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        }
        ...
        public City GetCityById(int cityId)
        {
            using (var db = new dbEduegateERPContext())
            {
                return db.Cities.Where(x => x.CityID == cityId)
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        }
        ...
        public List<City> GetCityByCompanyID(long companyID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return (from city in db.Cities
                        ...
                        select city).Distinct().OrderBy(a => a.CityName)
                        .AsNoTracking()
                        .ToList();
            }
        }
        ...
        public List<DocumentStatus> GetDocumentStatus()
        {
            try
            {
                using (dbEduegateERPContext db = new dbEduegateERPContext())
                {
                    return db.DocumentStatuses.OrderBy(d => d.StatusName)
                        .AsNoTracking()
                        .ToList();
                }
            }
        ...
        public IEnumerable<ActionLinkType> GetActionLinkTypes()
        {
            using (var db = new dbEduegateERPContext())
            {
                return db.ActionLinkTypes.OrderBy(a => a.ActionLinkTypeName)
                    .AsNoTracking()
                    .ToList();
            }
        }
        ...
        public string GetCultureCode(int cultureID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.Cultures.Where(x => x.CultureID == cultureID)
                    .AsNoTracking()
        ...
        public List<ScreenShortCut> GetShortCuts(long screenID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                return db.ScreenShortCuts.Where(x => x.ScreenID == screenID)
                    .AsNoTracking()
                    .ToList();
            }
        }

        public Sequence GetNextSequence(string sequenceTypes, short? schoolID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
                var sequence = db.Sequences
                    .Where(x => x.SequenceType == sequenceTypes && (schoolID == null || x.SchoolID == (byte?)schoolID))
                    .AsNoTracking()
                    .FirstOrDefault();
                ...
                if (sequence == null)
                {
                    sequence = db.Sequences
                        .Where(x => x.SequenceType == sequenceTypes)
                        .AsNoTracking()
                        .FirstOrDefault();
                }
