...
namespace Eduegate.Domain
{
    public class CustomerBL
    {
        ...
        public string AddSubscription(string Email)
        {
            ...
            subscription.SubscriptionEmail = Email;
        ...
        public List<SupplierAccountEntitlmentMapsDTO> SaveCustomerAccountMaps(List<SupplierAccountEntitlmentMapsDTO> customerAccountMapsDTOs)
        {
        ...
        public List<SupplierAccountEntitlmentMapsDTO> GetCustomerAccountMaps(long customerID)
        {
        ...
        public  List<CustomerAccountMap> FromAccountMapsDTOtoEntity(List<SupplierAccountEntitlmentMapsDTO> customerAccountMapsDTOs)
        {
            ...
            SupplierAccountEntitlmentMapsDTO baseEntitlementDTO = customerAccountMapsDTOs.Where(e => e.EntitlementID == null).FirstOrDefault();
            ...
            foreach (SupplierAccountEntitlmentMapsDTO dto in customerAccountMapsDTOs)
            {
        ...
        public  List<SupplierAccountEntitlmentMapsDTO> FromEntityToAccountMapsDTO(List<CustomerAccountMap> entityList)
        {
            //DTO for Customer Account map and Supplier Account map are same
            ...
            foreach (CustomerAccountMap entity in entityList)
            {
                ...
                if (entity.Account != null)
                {
                    ...
                    entitelmentAccount.AccountBehavior = entity.Account.AccountBehavoir != null ? (Eduegate.Infrastructure.Enums.AccountBehavior)entity.Account.AccountBehavoir.AccountBehavoirID : (Eduegate.Infrastructure.Enums.AccountBehavior?)null;
                    ...
                    entitelmentAccount.ParentAccount = entity.Account.ParentAccount != null ? new AccountDTO() { AccountID = entity.Account.ParentAccount.AccountID } : null;
