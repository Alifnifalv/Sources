    ...
    public class AccountMapper : IDTOEntityMapper<AccountDTO, Account>
    {
        ...
        public AccountDTO ToDTO(Account entity)
        {
            ...
            return new AccountDTO()
            {
               ...
               // AccountBehavior = entity.AccountBehavoirID.HasValue ? (Eduegate.Infrastructure.Enums.AccountBehavior)Enum.Parse(typeof(Eduegate.Infrastructure.Enums.AccountBehavior), entity.AccountBehavoirID.ToString()) : Eduegate.Infrastructure.Enums.AccountBehavior.Both,
        ...
        public Account ToEntity(AccountDTO dto)
        {
            return new Account()
            {
                ...
                GroupID =(int?) dto.ParentAccountID,
                ParentAccountID=dto.AccountGroupID,
