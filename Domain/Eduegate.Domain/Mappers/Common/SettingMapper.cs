...
{
    public class SettingMapper : IDTOEntityMapper<SettingDTO, Eduegate.Domain.Entity.Models.Setting>
    {
        ...
        public List<SettingDTO> ToDTO(List<Eduegate.Domain.Entity.Models.Setting> entities)
        {
            var dtos = new List<SettingDTO>();
        ...
        public SettingDTO ToDTO(Eduegate.Domain.Entity.Models.Setting entity)
        {
            if (entity == null)
            {
        ...
        public Eduegate.Domain.Entity.Models.Setting ToEntity(SettingDTO dto)
        {
            return new Eduegate.Domain.Entity.Models.Setting()
            {
