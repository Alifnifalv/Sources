    ...
    public class TicketMapper : IDTOEntityMapper<TicketDTO, Ticket>
    {
        ...
        public TicketDTO ToDTO(Ticket entity)
        {
            ...
            if (entity.IsNotNull())
            {
                ...
                ticketDTO.AssignedEmployeeID = entity.AssignedEmployeeID;
                ticketDTO.AssignedEmployeeName = entity.AssignedEmployeeID.IsNotNull() ? (new EmployeeBL(_context).GetEmployee(Convert.ToInt32(entity.AssignedEmployeeID)).IsNotNull() ? new EmployeeBL(_context).GetEmployee(Convert.ToInt32(entity.AssignedEmployeeID)).EmployeeName : string.Empty) : string.Empty;
                ...
                ticketDTO.IsSendCustomerNotification = entity.IsSendCustomerNotification;
        ...
        public Ticket ToEntity(TicketDTO dto)
        {
            ...
            if (dto.IsNotNull())
            {
                ...
                ticket.IsSendCustomerNotification = dto.IsSendCustomerNotification;
