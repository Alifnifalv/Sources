...
{
    [Keyless]
    public partial class Credit_Note_Full_Mismatched_20230117
    {
        ...
        [StringLength(255)]
        public string Correct_Invoice_No { get; set; }
        [StringLength(255)]
        public string REMARKS { get; set; }
        public long? New_StudentFeeDueID { get; set; }
        public long? New_FeeDueFeeTypeMapsID { get; set; }
        public long? New_FeeDueMonthlySplitID { get; set; }
        public int? New_YearID { get; set; }
        public int? New_MonthID { get; set; }
