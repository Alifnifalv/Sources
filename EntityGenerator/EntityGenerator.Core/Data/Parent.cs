...
namespace EntityGenerator.Core.Data
{
    ...
    [Index("ParentCode", Name = "IDX_Parents_ParentCode_")]
    [Index("LoginID", Name = "idx_ParentsLoginID")]
    public partial class Parent
    {
        ...
        [InverseProperty("ParentCanYouVolunteerToHelpOnes")]
        public virtual VolunteerType CanYouVolunteerToHelpOne { get; set; }
        [ForeignKey("CanYouVolunteerToHelpTwoID")]
        [InverseProperty("ParentCanYouVolunteerToHelpTwoes")]
        public virtual VolunteerType CanYouVolunteerToHelpTwo { get; set; }
        [ForeignKey("CountryID")]
        [InverseProperty("ParentCountries")]
        public virtual Country Country { get; set; }
        [ForeignKey("FatherCountryID")]
        [InverseProperty("ParentFatherCountries")]
        public virtual Nationality FatherCountry { get; set; }
        [ForeignKey("FatherPassportCountryofIssueID")]
        [InverseProperty("ParentFatherPassportCountryofIssues")]
        public virtual Country FatherPassportCountryofIssue { get; set; }
        [ForeignKey("GuardianCountryofIssueID")]
        [InverseProperty("ParentGuardianCountryofIssues")]
        public virtual Country GuardianCountryofIssue { get; set; }
        [ForeignKey("GuardianNationalityID")]
        [InverseProperty("ParentGuardianNationalities")]
        public virtual Nationality GuardianNationality { get; set; }
        [ForeignKey("LoginID")]
        [InverseProperty("Parents")]
        public virtual Login Login { get; set; }
        [ForeignKey("MotherCountryID")]
        [InverseProperty("ParentMotherCountries")]
        public virtual Nationality MotherCountry { get; set; }
        [ForeignKey("MotherPassportCountryofIssueID")]
        [InverseProperty("ParentMotherPassportCountryofIssues")]
        public virtual Country MotherPassportCountryofIssue { get; set; }
