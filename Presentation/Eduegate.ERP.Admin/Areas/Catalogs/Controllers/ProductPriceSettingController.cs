...
namespace Eduegate.ERP.Admin.Areas.Catalogs.Controllers
{
    public class ProductPriceSettingController : BaseSearchController
    {
        ...
        public ActionResult List()
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList(Eduegate.Services.Contracts.Enums.SearchView.ProductPriceSetting);
        ...
        {
            // call the service and get the meta data
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList(Eduegate.Services.Contracts.Enums.SearchView.ProductSKU);
        ...
        public ActionResult GetProductPriceSettings(long productIID)
        {
            ...
            return Json(productPriceSettings, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult SaveProductPriceSettings(List<ProductPriceSettingViewModel> productPriceSettings, long productIID)
        {
            ...
            return Json(new { IsError = !result, ProductPriceSettings = ppsVMs }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetPriceSettingCustomerGroups(long IID)
        {
            ...
            return Json(customerGroups, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult SavePriceSettingCustomerGroups(List<CustomerGroupViewModel> PriceCustomerGroupVMs, long productIID)
        {
            ...
            return Json(new { IsError = !result, UpdatedData = CustomerGroupVMs }, JsonRequestBehavior.AllowGet);
        }
