...
namespace Eduegate.ERP.Admin.Areas.Catalogs.Controllers
{
    public class PropertyTypeController : BaseSearchController
    {
        ...
        public ActionResult List()
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList(Eduegate.Services.Contracts.Enums.SearchView.PropertyType);
        ...
        [HttpPost]
        public JsonResult Save(PropertyTypeViewModel vm)
        {
