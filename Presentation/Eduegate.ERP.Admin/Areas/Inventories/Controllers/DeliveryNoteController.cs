...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    public class DeliveryNoteController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.DeliveryNote);
        ...
        [HttpPost]
        public JsonResult Save(DeliveryNoteViewModel vm)
        {
            try
            {
