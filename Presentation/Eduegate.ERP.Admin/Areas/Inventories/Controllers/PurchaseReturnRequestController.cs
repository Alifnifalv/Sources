...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    public class PurchaseReturnRequestController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.PurchaseReturnRequest);
        ...
        [HttpPost]
        public JsonResult Save(PurchaseReturnRequestViewModel vm)
        {
            try
            {
