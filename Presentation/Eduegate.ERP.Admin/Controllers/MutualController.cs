...
namespace Eduegate.ERP.Admin.Controllers
{
    public class MutualController : BaseController
    {
        ...
        [HttpPost]
        public bool SaveFilter(List<FilterValueViewModel> filter)
        {
        ...
        [HttpPost]
        public bool ResetFilter(List<FilterValueViewModel> filter)
        {
            if (filter == null) return true;
        ...
        public JsonResult GetLookUpData(Eduegate.Services.Contracts.Enums.LookUpTypes lookType, bool defaultBlank = true, bool isBlank = false, int optionalId = 0)
        {
            if (isBlank)
            {
                return Json(new KeyValueViewModel(), JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetDynamicLookUpData(DynamicLookUpType lookType, bool defaultBlank = true, bool isBlank = false, string searchText = "", string lookupName = "")
        {
            ...
            {
                return Json(new { LookUpName = lookupName, Data = VM }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        {
            var VM = KeyValueViewModel.FromDTO(ClientFactory.ReferenceDataServiceClient(CallContext).GetLookUpData((Eduegate.Services.Contracts.Enums.LookUpTypes)((int)lookType), searchText, Convert.ToInt32(ConfigurationExtensions.GetAppConfigValue("Select2DataSize")), 0));
            VM.Insert(0, new KeyValueViewModel() { Key = null, Value = string.Empty });
        ...
        public JsonResult GetLazyLookUpDataByReportField(string columnName, string searchText = "")
        {
            ...
            switch (columnName)
            {
                case "AllAccountID":
                    data = KeyValueViewModel.FromDTO(ClientFactory
                        ...
                        Convert.ToInt32(ConfigurationExtensions.GetAppConfigValue("Select2DataSize")), 0));
                    break;
                ...
                case "FISCALYEAR_ID":
                    ...
                    var YearList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.FiscalYear, searchText).ToList();
                ...
                case "COMP_ID":
                    ...
                    var CompanyList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Company, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in CompanyList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "DOCUMENT_TYPES":
                    ...
                    var DocumentTypeList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.DocumentTypes, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in DocumentTypeList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "MAINGROUP":
                    ...
                    var MainAccountGroupList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.MainAccountGroup, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in MainAccountGroupList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "SUBGROUP":
                    ...
                    var SubAccountGroupList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.SubAccountGroup, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in SubAccountGroupList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "GROUP_IDs":
                    ...
                    var GroupList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AccountGroup, searchText).ToList();
                ...
                case "ACCOUNT_IDs":
                    ...
                    var AccountIDsList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AccountIDs, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in AccountIDsList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "COSTCENTER_IDs":
                    ...
                    var CostCenterList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.CostCenterDetails, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in CostCenterList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "SL_ACCOUNT_IDs":
                    ...
                    var AccountSubLedgerList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AccountSubLedgers, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in AccountSubLedgerList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "PERIOD_TYPEs":
                    ...
                    var PeriodicalTypeList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.PeriodicalTypes, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in PeriodicalTypeList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "ACADEMIC_YEAR_IDs":
                    ...
                    var AcademicYearList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AcademicYear, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in AcademicYearList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "CLASS_IDs":
                    ...
                    var ClassList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Classes, searchText).ToList();
                ...
                case "SECTION_IDs":
                    ...
                    var SectionList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Section, searchText).ToList();
                ...
                case "FEEMASTER_IDs":
                    ...
                    var FeeMasterList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.FeeMaster, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in FeeMasterList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "STUDENT_IDs":
                    ...
                    var StudentList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Student, searchText).ToList();
                ...
                case "All_StudentIIDs":
                    ...
                    var AllStudentList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AllStudents, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in AllStudentList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "Candidate_IDs":
                    ...
                    var CandidateList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Candidate, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });

                    foreach (var entity in CandidateList)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                ...
                case "Employee_IDs":
                    ...
                    var EmployeeList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Employee, searchText).ToList();
                ...
                case "SUB_TEACHER_IDs":
                    ...
                    var TeacherList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.SubjectTeacher, searchText).ToList();
                    data.Add(new KeyValueViewModel() { Key = "0", Value = "All" });
                ...
                case "SUBJECTIDs":
                    ...
                    var SubjectList = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Subject, searchText).ToList();
                ...
                case "Stud_Applicants":
                    ...
                    var applicants = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Applicant_Student, searchText).ToList();
                ...
                case "PROD_IDs":
                    ...
                    var productDesc = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.ProductDescription, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "ALL" });

                    foreach (var entity in productDesc)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                case "EXAM_IDs":
                    ...
                    var examsName = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Exams, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "ALL" });

                    foreach (var entity in examsName)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
                case "FamilyIDs":
                    ...
                    var FamilyDesc = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.ProductFamily, searchText).ToList();

                    data.Add(new KeyValueViewModel() { Key = "0", Value = "ALL" });

                    foreach (var entity in FamilyDesc)
                    {
                        data.Add(new KeyValueViewModel() { Key = entity.Key, Value = entity.Value });
                    }
                    break;
            ...
            return Json(new { LookUpName = columnName, Data = data }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult UploadImages()
        {
            ...
            try
            {
                ...
                string tempFolderPath = string.Format("{0}{1}/{2}/{3}",
                    ConfigurationExtensions.GetAppConfigValue("ImagesPhysicalPath").ToString(), Request.Form["ImageType"], Constants.TEMPFOLDER, userID);
                ...
                foreach (string fileName in Request.Files)
                {
                    ...
                    if (file != null && file.ContentLength > 0)
                    {
                        ...
                        imageInfo.FilePath = string.Format("{0}{1}/{2}/{3}/{4}",
                            ConfigurationExtensions.GetAppConfigValue("ImageHostUrl").ToString(), Request.Form["ImageType"], Constants.TEMPFOLDER, userID, imageFileName);
        ...
        public ActionResult UploadDocument()
        {
            ...
            foreach (string fileName in Request.Files)
            {
                ...
                if (file != null && file.ContentLength > 0)
                {
                    ...
                    var path = ConfigurationExtensions.GetAppConfigValue("EmploymentRequestPhysicalPath");
                    if (!Directory.Exists(path))
                    {
                        Directory.CreateDirectory(path);
                    }
                    image.FileName = imageFileName;
                    image.FilePath = ConfigurationExtensions.GetAppConfigValue("EmploymentRequestPath") + imageFileName;
                    imageInfo.Add(image);
                    file.SaveAs(path + "/" + imageFileName);

                }
            }
            return Json(new { Success = true, FileInfo = imageInfo }, JsonRequestBehavior.AllowGet);
        }

        public ActionResult AdvancedFilter(SearchView view)
        {
            var paramview = view;
            ...
            var gridMetadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)view);
            ...
            if (docsVM.Count > 0)
            {
                foreach (var doc in docsVM)
                {
                    doc.FilePath = string.Format(@"{0}{1}/{2}/{3}/{4}",
                           ConfigurationExtensions.GetAppConfigValue("ImageHostUrl").ToString(), EduegateImageTypes.Documents.ToString(), entityType.ToString(), referenceID, doc.FileName);
                }
            }



            return Json(docsVM, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult ExecuteView(Eduegate.Services.Contracts.Enums.DynamicViews type, string IID1 = "", string IID2 = "")
        {
            ...
            return Json(ToJsonString(dto, false), JsonRequestBehavior.AllowGet);
        }
        ...
        {
            if (branchID == 0) Json(new List<KeyValueViewModel>(), JsonRequestBehavior.AllowGet);
        ...
        public JsonResult GetNextTransactionNumber(long documentTypeID)
        {
            ...
            return Json(transactionNo, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            var VM = new List<KeyValueViewModel>();
            var suppliersDTO = ClientFactory.SupplierServiceClient(CallContext).GetSuppliers(searchText, dataSize);
        ...
        [HttpPost]
        public JsonResult AddComment(CommentViewModel comment)
        {
        ...
        public ActionResult SubmitCommunication(CommunicationViewModel communication)
        {
            ...
            return Json(new { IsError = false, Response = crudSave }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetAreaByCountryID(int countryID)
        {
            ...
            return Json(areaVMList, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json("Sucessfull cleared the cache.", JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpGet]
        public JsonResult GetERPMenu(Eduegate.Services.Contracts.Enums.MenuLinkTypes menuLinkType)
        {
            var menuDto = ClientFactory.MenuServiceClient(CallContext).GetERPMenu(menuLinkType);
            var menuTree = MenuLinkViewModel.BuildMenuLinks(menuDto);
            return Json(menuTree, JsonRequestBehavior.AllowGet);
        }

        [HttpGet]
        public JsonResult GetERPMenuFlat(Eduegate.Services.Contracts.Enums.MenuLinkTypes menuLinkType)
        {
            var menuDto = ClientFactory.MenuServiceClient(CallContext).GetERPMenu(menuLinkType);
            //var menuTree = MenuLinkViewModel.BuildMenuLinks(menuDto);
            return Json(menuDto.OrderBy(a=> a.MenuLinkIID), JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetTaxTemplateItem(int taxTemplateID)
        {
            ...
            return Json(taxItem, JsonRequestBehavior.AllowGet);
        }

        public JsonResult GetScreenMetadata(Screens screen)
        {
            return Json(ClientFactory.MutualServiceClient(CallContext).GetShortCuts((long)screen), JsonRequestBehavior.AllowGet);
        }

        public JsonResult GetNextSequence(string sequenceType)
        {
            return Json(ClientFactory.MutualServiceClient(CallContext).GetNextSequence(sequenceType), JsonRequestBehavior.AllowGet);
        }
