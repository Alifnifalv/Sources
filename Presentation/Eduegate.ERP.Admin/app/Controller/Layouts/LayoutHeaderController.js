app.controller('LayoutHeaderController', ['$scope', '$http', "$rootScope", "subscriptionService", "$window", function ($scope, $http, $root, $subscription, $window) {
            ...
            success: function (result) {
                if (!result.IsError && result.Response != null) {
                    $scope.$apply(function () {
                        ...
                        $scope.SelectedSchool = $scope.HeaderInfoModel.SchoolID;
                        $scope.SelectedSchoolDetail = $scope.HeaderInfoModel.School;
                        $scope.SelectedAcademicYear = $scope.HeaderInfoModel.AcademicYearID;
    ...
    $scope.ChangeSchoolAcademicYear = function () {
        $("#ItemPopupSchool").show();
    ...
    $scope.FillAcademicYearBySchool = function () {
        ...
        $scope.AcademicYearList.forEach(x => {
            if (x.SchoolID == $scope.SelectedSchool) {
    ...
    $scope.SaveSchool = function () {
            ...
            $.ajax({
                url: "Account/ResetSchoolAcadamicYear",
                type: 'POST',
                data: { academicYearID: $scope.SelectedAcademicYear, schoolID: $scope.SelectedSchool },
                success: function (result) {
