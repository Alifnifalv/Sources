    ...
    public class SubscriptionSalesOrderController : BaseSearchController
    {
        ...
        public JsonResult Save(string model)
        {
            try
            {
                ...
                if (vm != null)
                {
                    var result = ClientFactory.TransactionServiceClient(CallContext).SaveTransactions(TransactionViewModel.ToSubscriptionSalesOrderDTO(vm));
                    updatedVM = TransactionViewModel.FromSubscriptionSalesOrderDTO(result);
