...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    ...
    public class SupplierController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList(
        ...
        public ActionResult Create(long ID = 0)
        {
            ...
            //viewModel.Urls.Add(new UrlViewModel() { LookUpName = "Infrastructure.Enums.LoginUserStatus", Url = "Mutual/GetLookUpData?lookType=Infrastructure.Enums.LoginUserStatus" });
        ...
        {
            SupplierViewModel supplierModel = SupplierViewModel.FromDTO(ClientFactory.SupplierServiceClient(CallContext, null).GetSupplier(ID.ToString()));
        ...
        {
            return Json(SupplierDetailViewModel.FromDTO(ClientFactory.SupplierServiceClient(CallContext, null).GetSupplier(ID.ToString())));
        }
        ...
        public ActionResult SupplierCreation(SupplierViewModel supplierModel)
        {
            ...
            {
                var dto = ClientFactory.SupplierServiceClient(CallContext, null).GetSupplier(supplierModel.SupplierIID.ToString());
        ...
        [HttpPost]
        public JsonResult Save([FromBody] SupplierViewModel supplierModel)
        {
            try
            {
                if (supplierModel != null)
                {
                    ...
                    //var resultSupplierDTO = ClientFactory.SupplierServiceClient(CallContext, null).SaveSupplier(SupplierViewModel.ToDTO(supplierModel));

                    var resultSupplierDTO = new SupplierDTO();
                    ...
                    if (resultSupplierDTO.IsNotNull() && resultSupplierDTO.SupplierIID > 0)
                    {
                        ...
                        //       new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Documents.ToString(), Eduegate.Framework.Contracts.Common.Enums.EntityTypes.Supplier.ToString(), resultSupplierDTO.SupplierIID);
        ...
        public JsonResult GetCountryMasters()
        {
            ...
            return Json(new { IsError = false, CountryMasters = countryMasterViewModelList });
        }
        ...
        public JsonResult GetSupplierBySupplierIdAndCR(string lookupName, string searchText)
        {
            try
            {
                var dtos = ClientFactory.SupplierServiceClient(CallContext, null).GetSupplierBySupplierIdAndCR(searchText);
        ...
        {
            var dtoSupplierStatuses = ClientFactory.SupplierServiceClient(CallContext, null).GetSupplierStatuses();
        ...
        {
            var result = ClientFactory.SupplierServiceClient(CallContext, null).GetSupplierDeliveryMethod(supplierID);
            return Json(result);
        }
        ...
        {
            var result = ClientFactory.SupplierServiceClient(CallContext, null).GetSupplierReturnMethod(supplierID);
            return Json(result);
        }
    }
}