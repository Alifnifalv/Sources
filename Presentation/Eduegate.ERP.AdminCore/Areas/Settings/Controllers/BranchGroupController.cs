...
namespace Eduegate.ERP.Admin.Areas.Settings.Controllers
{
    ...
    public class BranchGroupController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.BranchGroup);
        ...
        [HttpPost]
        public JsonResult Save([FromBody] BranchGroupViewModel vm)
        {
