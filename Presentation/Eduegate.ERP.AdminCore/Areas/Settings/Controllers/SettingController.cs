...
namespace Eduegate.ERP.Admin.Areas.Settings.Controllers
{
    ...
    public class SettingController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult SmartSettings()
        {
            return View(SettingConfigureGroupViewModel
                .ToGroupVM(ClientFactory.SettingServiceClient(CallContext)
                .GetSettingByGroup("Integration")));
        }
