...
namespace Eduegate.ERP.Admin.Controllers
{
    public class MutualController : BaseController
    {
        ...
        public JsonResult GetLazyLookUpDataByReportField(string columnName, string searchText = "")
        {
            ...
            switch (columnName.ToUpper())
            {
                ...
                case "NATIONALITYID":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Nationality, searchText).ToList();
                ...
                case "ROUTEID":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Route, searchText).ToList();
                ...
                case "PICKUPSTOPID":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.PickupStopALL, searchText).ToList();
                ...
                case "DROPSTOPID":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.DropStopALL, searchText).ToList();
                ...
                case "DRIVER":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Driver, searchText).ToList();
                ...
                case "ATTENDERNAME":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.VehicleAttender, searchText).ToList();
                ...
                case "ASSETCATEGORYIDS":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.AssetCategories, searchText).ToList();
                ...
                case "ASSETID":
                    ...
                    keyValueDTOs = ClientFactory.ReferenceDataServiceClient(CallContext).GetDynamicLookUpData(DynamicLookUpType.Assets, searchText).ToList();
        ...
        public JsonResult GetAssetCategories()
        {
            ...
            VM = assetCategoryList.Select(x => new KeyValueViewModel()
            {
                Key = x.AssetCategoryID.ToString(),
        ...
        public FileContentResult GetDynamicImage(string displayText, bool noisy = true)
        {
            ...
            using (var gfx = Graphics.FromImage((System.Drawing.Image)bmp))
            {
                ...
                var color = System.Drawing.Color.FromArgb(
                        ...
                        (rand.Next(0, 255)),
                        (rand.Next(0, 255)));
                gfx.FillRectangle(Brushes.Blue, new System.Drawing.Rectangle(0, 0, bmp.Width, bmp.Height));
                //add question
        ...
        [AllowAnonymous]
        public IActionResult GenerateBarcode(string text, BarcodeFormat format = BarcodeFormat.CODE_128, int height = 500, int width = 1000, int margin = 5)
        {
            ...
            image.SaveAsPng(stream); // Save as PNG format
