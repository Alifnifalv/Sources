...
namespace Eduegate.ERP.AdminCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<AzureAd>(options =>
            {
            ...
            // Manually add PowerBI configuration
            ...
            services.AddTransient<PbiEmbedService>();
            services.AddTransient<AadService>();
