app.controller("AccountVoucherController", ["$scope", "$http", "$compile", "$window", "$timeout", "$location", "$route", "$controller", function ($scope, $http, $compile, $window, $timeout, $location, $route, $controller) {
    $controller('CRUDController', { $scope: $scope, $compile: $compile, $http: $http, $timeout: $timeout, $window: $window, $location: $location, $route: $route });

    console.log("AccountVoucherController Controller");

    $scope.DocumentTypeChange = function () {
        var GetNextTransactionNumberByMonthYearUrl = 'Accounts/RVMission/GetNextTransactionNumberByMonthYear';
        $.ajax({
            type: "POST",
    ...
    $scope.GetNextTransactionNumber = function () {
        ...
        var GetNextTransactionNumberByMonthYearUrl = 'Accounts/JV/GetNextTransactionNumberByMonthYear';
        $.ajax({
            type: "POST",
            url: GetNextTransactionNumberByMonthYearUrl,
            contentType: "application/json;charset=utf-8",
    ...
    $scope.AccountCodeChange = function (model, dataType, control, multiplesingle, currentRow, rowIndex) {
        ...
        $.ajax({
            url: "Accounts/RVMission/GetReceivablesByAccountId?AccountID=" + currentRow.DetailAccount.Key + "&DocumentType=" + currentRow.DocumentReferenceTypeID,
            type: 'GET',
