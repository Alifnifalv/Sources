            ...
            $.ajax({
                ...
                success: function (result) {
                    $scope.$apply(function () {
                        ...
                        $timeout(function () {
                            if (googleMap && vm.SchoolSettingPath.length > 0) {
                                const firstPoint = new google.maps.LatLng(vm.SchoolSettingPath[0][0], vm.SchoolSettingPath[0][1]);
                                googleMap.setCenter(firstPoint);
                                googleMap.setZoom(7); 
                            }
                        });
