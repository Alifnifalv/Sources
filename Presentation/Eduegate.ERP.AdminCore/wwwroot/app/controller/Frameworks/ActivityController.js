    ...
    function ($scope, $http, moment, alert, $compile, $subscription) {
        ...
        vm.Init = function (window) {
            ...
            pagination.initialize('activityStream', false, 'ActivityIID',
                '.overlaySummaryInner', $('#activityWayPoint'))
        ...
        vm.DetailView = function (data, event) {
            $('#summarypanel', vm.WindowContainer).html(' <center><span class="fa fa-circle-o-notch fa-pulse" style="font-size:20px;color:black;"></span></center>')
