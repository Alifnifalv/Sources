app.controller('DesignBoardController', ['$scope', '$http', 'moment', '$compile', '$element', '$timeout',
    function ($scope, $http, moment, $compile, $element, $timeout) {
        let canvas;
        let number;
        const grid = 30;
        ...
        $scope.init = function (mode) {
            $(document).ready(function () {               
                ...
                if (document.querySelectorAll('.rectangle')[0]) {
                ...
                if (document.querySelectorAll('.circle')[0]) {
                ...
                if (document.querySelectorAll('.triangle')[0]) {
                ...
                if (document.querySelectorAll('.chair')[0]) {
                ...
                if (document.querySelectorAll('.bar')[0]) {
                ...
                if (document.querySelectorAll('.wall')[0]) {
                ...
                if (document.querySelectorAll('.remove')[0]) {
        ...
        $scope.CustomerMode = function () {
            ...
            if (document.querySelectorAll('.admin-menu')[0]) {
                document.querySelectorAll('.admin-menu')[0].style.display = 'none';
            }

            if (document.querySelectorAll('.customer-menu')[0]) {
