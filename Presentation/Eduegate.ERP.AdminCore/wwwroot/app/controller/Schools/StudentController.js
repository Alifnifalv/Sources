app.controller("StudentController", ["$scope", "$http", "$compile", "$window", "$timeout", "$location", "$route", "$controller", function ($scope, $http, $compile, $window, $timeout, $location, $route, $controller) {
    ...
    $scope.ClassChangesforStream = function () {
        ...
        var id = $scope.CRUDModel.ViewModel.StudentClass.Key;
    ...
    $scope.LoadClassHistory = function (studentID) {

        //if (studentID) {
        //    showOverlay();
        //    var url = utility.myHost + "Schools/School/GetStudentDetails?studentID=" + studentID;
        //    $http({ method: 'Get', url: url })
        //        .then(function (result) {
        //hideOverlay();
        var data=null//result.data
        $scope.AddWindow('StudentClasshistory', 'StudentClasshistory', 'StudentClasshistory');

        $('#' + 'StudentClasshistory', '#LayoutContentSection').replaceWith($compile(data)($scope));
        $scope.ShowWindow('StudentClasshistory', 'StudentClasshistory', 'StudentClasshistory');
