...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "SerialEntryGrids", "CRUDModel.ViewModel.AssetSerialEntry.SerialEntryGrids")]
    [DisplayName("SerialEntryGrids")]
    [Pagination(10, "default")]
    public class AssetSerialEntryGridViewModel : BaseMasterViewModel
    {
        public AssetSerialEntryGridViewModel()
        {
            IsRowDisabled = true;
            SLNo = null;
        }
