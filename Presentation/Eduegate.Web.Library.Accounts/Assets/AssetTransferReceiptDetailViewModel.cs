...
namespace Eduegate.Web.Library.Accounts.Assets
{
    ...
    public class AssetTransferReceiptDetailViewModel : BaseMasterViewModel
    {
        public AssetTransferReceiptDetailViewModel()
        {
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.DatePicker, "", Attributes2 = "CheckLastDayOfMonth(detail, \"CutOffDateString\")", Attributes = "ng-disabled = true")]
