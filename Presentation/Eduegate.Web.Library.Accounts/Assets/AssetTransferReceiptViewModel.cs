...
{
    public class AssetTransferReceiptViewModel : BaseMasterViewModel
    {
        public AssetTransferReceiptViewModel()
        {
        ...
        public AssetTransferReceiptMasterViewModel MasterViewModel { get; set; }
        public List<AssetTransferReceiptDetailViewModel> DetailViewModel { get; set; }

        public static AssetTransferReceiptViewModel ToVM(AssetTransactionDTO dto)
        {
            if (dto.IsNotNull())
            {
                var at = new AssetTransferReceiptViewModel();
                at.MasterViewModel = new AssetTransferReceiptMasterViewModel();
                at.DetailViewModel = new List<AssetTransferReceiptDetailViewModel>();
                ...
                at.MasterViewModel.DocumentReferenceTypeID = dto.AssetTransactionHead.DocumentReferenceTypeID.HasValue ? dto.AssetTransactionHead.DocumentReferenceTypeID : DocumentReferenceTypes.AssetTransferReceipt;
                ...
                if (dto.AssetTransactionDetails != null && dto.AssetTransactionDetails.Count > 0)
                {
                    ...
                    {
                        var atDetail = new AssetTransferReceiptDetailViewModel();
                ...
                return new AssetTransferReceiptViewModel();
        }

        public static AssetTransactionDTO ToDTO(AssetTransferReceiptViewModel vm)
        {
            var dateFormat = new Domain.Setting.SettingBL().GetSettingValue<string>("DateFormat");
            if (vm.IsNotNull())
            {
                ...
                if (vm.MasterViewModel.IsNotNull())
                {
                    ...
                    if (string.IsNullOrEmpty(vm.MasterViewModel.ReferenceTransactionHeaderID))
                    {
                        throw new Exception("Saving is only allowed if a transfer issue is selected!");
                    }
