...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "AssetTransferRequestMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Asset Transfer Request Details")]
    public class AssetTransferRequestMasterViewModel : BaseMasterViewModel
    {
        public AssetTransferRequestMasterViewModel()
        {
            DocumentReferenceTypeID = DocumentReferenceTypes.AssetTransferRequest;
        }
