...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "Forecasting", "CRUDModel.ViewModel")]
    [DisplayName("Forecasting")]
    public class ForecastingViewModel : BaseMasterViewModel
    {
        ...
        {
            Mapper<BudgetEntryDTO, ForecastingViewModel>.CreateMap();
           ...
           // Mapper<BudgetingAccountsDTO, BudgetingAccountDetailViewModel>.CreateMap();
            ...
            var vm = Mapper<BudgetEntryDTO, ForecastingViewModel>.Map(dto as BudgetEntryDTO);
        ...
        {
            Mapper<ForecastingViewModel, BudgetEntryDTO>.CreateMap();
            Mapper<KeyValueViewModel, KeyValueDTO>.CreateMap();
           
            var dto = Mapper<ForecastingViewModel, BudgetEntryDTO>.Map(this);
            var dateFormat = new Domain.Setting.SettingBL().GetSettingValue<string>("DateFormat");
