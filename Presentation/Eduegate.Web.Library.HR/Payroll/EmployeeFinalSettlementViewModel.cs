...
{
    public class EmployeeFinalSettlementViewModel : BaseMasterViewModel
    {

        public EmployeeFinalSettlementViewModel()
        {
        ...
        [CustomDisplay("Final Settlement Date")]
        public string LeaveSalarySettlementDateToString { get; set; }
        public System.DateTime? LeaveSalarySettlementDate { get; set; }


        [ControlType(Framework.Enums.ControlTypes.DatePicker, Attributes = "ng-change='CalculationDateChanges(CRUDModel.ViewModel,2)'")]
        ...
        [Select2("FullEmployee", "Numeric", false)]
        ...
        [DisplayName("End Of Service Days Entitlement Per Year")]
        public decimal? EndofServiceDays { get; set; }


        [ControlType(Framework.Enums.ControlTypes.NewLine, "fullwidth alignleft")]
        [DisplayName("")]
        public string NewLine15 { get; set; }

        [ControlType(Framework.Enums.ControlTypes.TextBox)]
        [DisplayName("No.of Days in a month (Leave Salary)")]
        public decimal? NoofDaysInTheMonthLS { get; set; }


        [ControlType(Framework.Enums.ControlTypes.TextBox)]
        [DisplayName("No of Days In The Month (EoSB)")]
        ...
        [ControlType(Framework.Enums.ControlTypes.DatePicker)]
        [CustomDisplay("Date Of Leaving")]
        public string DateOfLeavingString { get; set; }
        public System.DateTime? DateOfLeavingDate { get; set; }

        [ControlType(Framework.Enums.ControlTypes.Button, Attributes = "ng-Click=FillFinalSettlementDetails(CRUDModel.ViewModel,2)")]
        [CustomDisplay("Fill")]
        ...
        [ControlType(Framework.Enums.ControlTypes.Button, Attributes = "ng-Click=SaveFinalSalarySettlement(CRUDModel.ViewModel,2)")]
        ...
        {
            return JsonConvert.DeserializeObject<EmployeeFinalSettlementViewModel>(jsonString);
        }

        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            Mapper<EmployeeSettlementDTO, EmployeeFinalSettlementViewModel>.CreateMap();
            Mapper<KeyValueDTO, KeyValueViewModel>.CreateMap();


            var dateFormat = new Domain.Setting.SettingBL().GetSettingValue<string>("DateFormat");
            var ssDto = dto as EmployeeSettlementDTO;
            var vm = Mapper<EmployeeSettlementDTO, EmployeeFinalSettlementViewModel>.Map(ssDto);
            ...
            vm.DateOfLeavingString = (ssDto.DateOfLeaving.HasValue ? ssDto.DateOfLeaving.Value : DateTime.Now).ToString(dateFormat, CultureInfo.InvariantCulture);
            vm.EndofServiceDays = ssDto.EndofServiceDaysPerYear;
            vm.NoofDaysInTheMonthLS = ssDto.NoofDaysInTheMonthLS;
            vm.NoofDaysInTheMonthEoSB = ssDto.NoofDaysInTheMonthEoSB;
        ...
        {
            Mapper<EmployeeFinalSettlementViewModel, EmployeeSettlementDTO>.CreateMap();
            Mapper<KeyValueViewModel, KeyValueDTO>.CreateMap();
            var dto = Mapper<EmployeeFinalSettlementViewModel, EmployeeSettlementDTO>.Map(this);
            ...
            dto.NoofDaysInTheMonthLS = this.NoofDaysInTheMonthLS;
            ...
            {
                if (salaryComp.SalaryComponent != null && !string.IsNullOrEmpty(salaryComp.SalaryComponent.Key) && (salaryComp.Earnings.HasValue || salaryComp.Deduction.HasValue))
                {
