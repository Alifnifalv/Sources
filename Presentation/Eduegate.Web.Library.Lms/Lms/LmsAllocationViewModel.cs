...
{
    public class LmsAllocationViewModel : BaseMasterViewModel
    {
        public LmsAllocationViewModel()
        {
        ...
        {
            return JsonConvert.DeserializeObject<LmsAllocationViewModel>(jsonString);
        }

        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            Mapper<SignupSlotAllocationMapDTO, LmsAllocationViewModel>.CreateMap();
            var allocDtO = dto as SignupSlotAllocationMapDTO;
            var vm = Mapper<SignupSlotAllocationMapDTO, LmsAllocationViewModel>.Map(dto as SignupSlotAllocationMapDTO);
        ...
        {
            Mapper<LmsAllocationViewModel, SignupSlotAllocationMapDTO>.CreateMap();
            var dto = Mapper<LmsAllocationViewModel, SignupSlotAllocationMapDTO>.Map(this);
