...
namespace Eduegate.Web.Library.SignUp.Meeting
{
    public class MeetingRequestViewModel : BaseMasterViewModel
    {
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.CheckBox, "", attribs: "ng-change='SameDateBoxClick($event, $element,CRUDModel.ViewModel)'")]
        [CustomDisplay("Is Approval Date Same As Requested")]
        public bool IsDateSame { get; set; }

        [Required]
        [ControlType(Framework.Enums.ControlTypes.CheckBox, "", attribs: "ng-change='SameTimeBoxClick($event, $element,CRUDModel.ViewModel)'")]
        ...
        [Select2("ApprovedSlotMap", "String", false)]
