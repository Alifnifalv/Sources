...
namespace Eduegate.Web.Library.OnlineExam.OnlineExam
{
    ...
    public class ExamQuestionGroupMapViewModel : BaseMasterViewModel
    {
        ...
        [CustomDisplay("NumberOfQuestions")]
        public long? NumberOfQuestions { get; set; }

        [ControlType(Framework.Enums.ControlTypes.Label)]
        [CustomDisplay("TotalNoOfPassageQuestions")]
        public long? TotalNoOfPassageQuestions { get; set; }

        [Required]
        [ControlType(Framework.Enums.ControlTypes.TextBox)]
        [CustomDisplay("NumberOfPassageQuestions")]
        public long? NumberOfPassageQuestions { get; set; }
