...
namespace Eduegate.Web.Library.OnlineExam.OnlineExam
{
    public class OnlineQuestionsViewModel : BaseMasterViewModel
    {
        ...
        [ControlType(Framework.Enums.ControlTypes.Select2)]
        [Select2("PassageQuestions", "Numeric", false, "PassageQuestionChanges(CRUDModel.ViewModel)")]
        [LazyLoad("", "Mutual/GetDynamicLookUpData?lookType=PassageQuestions", "LookUps.PassageQuestions")]
        ...
        //[DisplayName("Passage Question")]
        public KeyValueViewModel PassageQuestion { get; set; }
        ...
        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            ...
            vm.PassageQuestion = qnDto.PassageQuestionID.HasValue ? new KeyValueViewModel() { Key = qnDto.PassageQuestionID.ToString(), Value = qnDto.PassageShortDescription } : new KeyValueViewModel();
        ...
        public override BaseMasterDTO ToDTO()
        {
            ...
            dto.PassageQuestionID = this.PassageQuestion.Key.IsNull() ? (long?)null : long.Parse(this.PassageQuestion.Key);
