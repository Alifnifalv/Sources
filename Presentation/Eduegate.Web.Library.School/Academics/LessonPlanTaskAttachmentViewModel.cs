...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "LessonPlanTaskAttach", "gridModel.LessonPlanTaskAttach")]
    [DisplayName("Task Upload")]
    public class LessonPlanTaskAttachmentViewModel : BaseMasterViewModel
    {
        ...
        {
            return JsonConvert.DeserializeObject<LessonPlanTaskAttachmentViewModel>(jsonString);
        }
