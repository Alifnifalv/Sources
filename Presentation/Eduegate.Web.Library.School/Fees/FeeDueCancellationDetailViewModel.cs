...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "FeeDueCancellationDetail", "CRUDModel.ViewModel.FeeDueDetails")]
    [DisplayName("Fee Due Cancellation Detaill")]
    public class FeeDueCancellationDetailViewModel : BaseMasterViewModel
    {
        public FeeDueCancellationDetailViewModel()
        {
