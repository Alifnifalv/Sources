...
namespace Eduegate.Web.Library.School.Mutual
{
    public class AcademicYearViewModel : BaseMasterViewModel
    {
        ...
        [ControlType(Framework.Enums.ControlTypes.CheckBox)]
        [CustomDisplay("IsUsedForApplication")]
        ...
        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            ...
            vm.IsUsedForApplication = acDtO.IsUsedForApplication;
        ...
        public override BaseMasterDTO ToDTO()
        {
            ...
            dto.IsUsedForApplication = this.IsUsedForApplication;
