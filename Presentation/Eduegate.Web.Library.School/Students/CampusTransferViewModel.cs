...
namespace Eduegate.Web.Library.School.Students
{
    ...
    public class CampusTransferViewModel : BaseMasterViewModel
    {
        ...
        [LazyLoad("", "Mutual/GetDynamicLookUpData?lookType=ToCampusTransferStudents", "LookUps.ToCampusTransferStudents")]
        ...
        public override BaseMasterDTO ToDTO()
        {
            ...
            dto.OtherFeeTotalFromCampus = this.OtherFeeTotalFromCampus;
