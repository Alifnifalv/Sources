...
namespace Eduegate.Web.Library.SignUp.SignUps
{
    ...
    //[DisplayName("Signup")]
    public class SignupViewModel : BaseMasterViewModel
    {
        public SignupViewModel()
        {
            SignupSlotMaps = new List<SignupSlotMapViewModel>() { new SignupSlotMapViewModel() };
            SignupFilter = new SignupFilterViewModel();
        ...
        public SignupFilterViewModel SignupFilter { get; set; }
        ...
        public List<SignupSlotMapViewModel> SignupSlotMaps { get; set; }
        ...
        {
            return JsonConvert.DeserializeObject<SignupViewModel>(jsonString);
        }

        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            Mapper<SignUpDTO, SignupViewModel>.CreateMap();
            Mapper<KeyValueDTO, KeyValueViewModel>.CreateMap();
            var signDTO = dto as SignUpDTO;
            var vm = Mapper<SignUpDTO, SignupViewModel>.Map(dto as SignUpDTO);
            ...
            vm.NotificationStatus = signDTO.NotificationStatus;

            vm.SignupSlotMaps = new List<SignupSlotMapViewModel>();
            foreach (var map in signDTO.SignupSlotMaps)
            {
                vm.SignupSlotMaps.Add(new SignupSlotMapViewModel
                {
        ...
        {
            Mapper<SignupViewModel, SignUpDTO>.CreateMap();
            Mapper<KeyValueViewModel, KeyValueDTO>.CreateMap();
            var dto = Mapper<SignupViewModel, SignUpDTO>.Map(this);
            ...
            dto.IsSendNotification = this.IsSendNotification ?? false;
