...
namespace Eduegate.Web.Library.ViewModels.AccountTransactions
{
    public class DebitProductViewModel : BaseMasterViewModel
    {
        ...
        public DebitProductViewModel ToDebitProductViewModel(AccountTransactionHeadDTO headDTO)
        {
            ...
            debitproductViewModel.MasterViewModel.ErrorCode = headDTO.ErrorCode;
            debitproductViewModel.MasterViewModel.IsError = headDTO.IsError;
            debitproductViewModel.ErrorCode = headDTO.ErrorCode;
            debitproductViewModel.IsError = headDTO.IsError;
