...
namespace Eduegate.Web.Library.ViewModels.AccountTransactions
{
    public class JVViewModel : BaseMasterViewModel
    {
        ...
        public JVViewModel ToJVViewModel(AccountTransactionHeadDTO headDTO)
        {
            ...
            jvViewModel.MasterViewModel.ErrorCode = headDTO.ErrorCode;
            jvViewModel.MasterViewModel.IsError = headDTO.IsError;
            jvViewModel.ErrorCode = headDTO.ErrorCode;
            jvViewModel.IsError = headDTO.IsError;
