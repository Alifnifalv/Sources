...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "MCGridAccountCancelFeeType", "CRUDModel.ViewModel.MCTabAccountsCancelled.MCGridAccountCancelFeeType")]
    [DisplayName("Fee General")]
    [Pagination(5, "default")]
    public class MCGridAccountCancelTypeViewModel : BaseMasterViewModel
    {
        public MCGridAccountCancelTypeViewModel()
        {
