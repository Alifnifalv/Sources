...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "MCGridFeeDueFeeMaster", "gridModel.MCGridFeeDueFeeMaster")]
    [DisplayName("Fee General")]
    public class MCGridFeeDueFeeMasterViewModel : BaseMasterViewModel
    {
        public MCGridFeeDueFeeMasterViewModel()
        {
