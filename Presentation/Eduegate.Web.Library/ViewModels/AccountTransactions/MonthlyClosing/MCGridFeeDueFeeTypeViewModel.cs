...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "MCGridFeeDueFeeType", "CRUDModel.ViewModel.MCTabFeeDueGeneral.MCGridFeeDueFeeType")]
    [DisplayName("Fee General")]
    //[Pagination(10, "default")]
    public class MCGridFeeDueFeeTypeViewModel : BaseMasterViewModel
    {
        public MCGridFeeDueFeeTypeViewModel()
        {
