...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "MCGridInventoryTransType", "CRUDModel.ViewModel.MCTabInventory.MCGridInventoryTransType")]
    [DisplayName("Invoice General")]
    public class MCGridInventoryTransTypeViewModel : BaseMasterViewModel
    {
        public MCGridInventoryTransTypeViewModel()
        {
