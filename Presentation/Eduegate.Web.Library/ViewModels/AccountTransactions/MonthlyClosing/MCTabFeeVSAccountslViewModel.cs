   ...
   public class MCTabFeeVSAccountslViewModel : BaseMasterViewModel
    {
        ...
        [ControlType(Framework.Enums.ControlTypes.Button, Attributes = "ng-Click=ViewFeeVSAccountsFeeTypeDetails()")]
        [CustomDisplay("Fill Data")]
        public string ViewFeeVSAccountsFeeTypeButton { get; set; }
