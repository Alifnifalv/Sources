...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "PVInvoiceTransactionHead", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("General")]
    public class PVInvoiceMasterViewModel : BaseMasterViewModel
    {
        public PVInvoiceMasterViewModel()
        {
        ...
        [Select2("CreditAccounts", "Numeric")]
        [LazyLoad("", "Accounts/RVMission/GetChildAccounts_ByParentAccountId", "LookUps.CreditAccounts")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.Select2)]
        [CustomDisplay("SupplierAccount")]
        [Select2("SupplierAccounts", "Numeric", false, "LoadSupplierPendingInvoices")]
        [LazyLoad("", "Accounts/RVMission/Get_AllSuppliers_Accounts", "LookUps.SupplierAccounts")]
