...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "PVMissionTransactionDetails", "CRUDModel.Model.DetailViewModel")]
    public class PVMissionDetailViewModel : BaseMasterViewModel
    {
        public PVMissionDetailViewModel()
        {
