...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "PVRegularPaymentTransactionDetails", "CRUDModel.Model.DetailViewModel")]
    public class PVRegularPaymentDetailViewModel : BaseMasterViewModel
    {
        public PVRegularPaymentDetailViewModel()
        {
