...
namespace Eduegate.Web.Library.ViewModels.AccountTransactions
{
    ...
    public class RegularCreditMasterViewModel : BaseMasterViewModel
    {
        public RegularCreditMasterViewModel()
        {
            ...
            InvoiceID = new KeyValueViewModel();
        }
        ...
        [Select2("CustomerAccount", "Numeric", false, "CustomerAccountChangesInCreditNote($event, $element)")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.Select2)]
        [Select2("PendingInvoices", "Numeric", false, "GetPendingInvoiceDetails($event, $element)")]
        [LookUp("LookUps.PendingInvoices")]
        [CustomDisplay("Pending Invoices")]
        public KeyValueViewModel InvoiceID { get; set; }
