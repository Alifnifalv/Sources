...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "RegularDebitTransactionHead", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("General")]
    public class RegularDebitMasterViewModel : BaseMasterViewModel
    {
        public RegularDebitMasterViewModel()
        {
            DocumentReferenceTypeID = Services.Contracts.Enums.DocumentReferenceTypes.DebitNote;
