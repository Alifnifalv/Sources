...
namespace Eduegate.Web.Library.ViewModels.Inventory
{
    ...
    public class BundleUnWrapDetailViewModel : BaseMasterViewModel
    {
        public BundleUnWrapDetailViewModel()
        {
        ...
        [Select2("SKUID", "String", false, "OnBundleSelect($event, $element, detail)",false, optionalAttribute1: "ng-disabled=CRUDModel.Model.DetailViewModel")]
