...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "BundleUnWrapMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Bundle Un Wrap Details")]
    public class BundleUnWrapMasterViewModel : BaseMasterViewModel
    {
        public BundleUnWrapMasterViewModel()
        {
        ...
        [DataPicker("BundleWrapAdvanceSearch")]
