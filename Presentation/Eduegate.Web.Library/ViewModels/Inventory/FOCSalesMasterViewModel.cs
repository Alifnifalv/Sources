...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "FOCSalesMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Order Details")]
    public class FOCSalesMasterViewModel : BaseMasterViewModel
    {
        public FOCSalesMasterViewModel()
        {
        ...
        [CustomDisplay("SelectStaff")]

        public string ReferenceStaff { get; set; }

        //[Required]
        [ControlType(Framework.Enums.ControlTypes.Select2)]
        [CustomDisplay("Staff")]
        [Select2("Employee", "Numeric", false, "OnChangeSelect2", false, optionalAttribute1: "ng-disabled='CRUDModel.Model.MasterViewModel.Student.Key || CRUDModel.Model.MasterViewModel.Customer.Key'")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.Select2/*, "onecol-header-left"*/)]
        [Select2("Student", "String", false, "ChangeInventoryStudent($event, $element,CRUDModel.Model.MasterViewModel)", false, optionalAttribute1: "ng-disabled='CRUDModel.Model.MasterViewModel.Customer.Key || CRUDModel.Model.MasterViewModel.Employee.Key'")]
        ...
        [Select2("Customer", "Numeric", false, "OnChangeSelect2", false, optionalAttribute1: "ng-disabled='CRUDModel.Model.MasterViewModel.Student.Key || CRUDModel.Model.MasterViewModel.Employee.Key'")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.DatePicker, "alignleft")]
