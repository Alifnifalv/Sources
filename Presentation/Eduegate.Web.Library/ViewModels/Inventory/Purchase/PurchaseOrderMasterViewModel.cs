...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "PurchaseOrderMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Order Details")]
    public class PurchaseOrderMasterViewModel : BaseMasterViewModel
    {
        public PurchaseOrderMasterViewModel()
        {
    ...
    public class MarketPlaceTransactionActionViewModel : PurchaseOrderMasterViewModel
    {
