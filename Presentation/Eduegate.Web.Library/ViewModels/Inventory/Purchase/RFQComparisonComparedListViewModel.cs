...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "ComparedList", "CRUDModel.ViewModel.ComparedList")]
    [DisplayName("Compared List")]
    public class RFQComparisonComparedListViewModel : BaseMasterViewModel
    {
        public RFQComparisonComparedListViewModel()
        {
        ...
        [ControlType(Framework.Enums.ControlTypes.Button, "x-small-col-width", "ng-click='RemoveGridRow($index, CRUDModel.ViewModel.ComparedList[0], CRUDModel.ViewModel.ComparedList)'")]
        [DisplayName("-")]
