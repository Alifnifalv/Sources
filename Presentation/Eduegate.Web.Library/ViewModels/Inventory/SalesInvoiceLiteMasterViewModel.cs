...
namespace Eduegate.Web.Library.ViewModels.Inventory
{
    ...
    public class SalesInvoiceLiteMasterViewModel : BaseMasterViewModel
    {
        public SalesInvoiceLiteMasterViewModel()
        {
        ...
        [DataPicker("CanteenSalesOrderAdvanceSearch")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.Select2)]
        [CustomDisplay("Delivery Slot")]
        [LookUp("LookUps.DeliverySlot")]
        [Select2("DeliverySlot", "Numeric", false, "", false, optionalAttribute1: "ng-disabled='true'")]
        //[HasClaim(HasClaims.HASMULTICURRENCY)]
        public KeyValueViewModel DeliverySlot { get; set; }
