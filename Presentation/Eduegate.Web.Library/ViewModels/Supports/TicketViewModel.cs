    ...
    public class TicketViewModel : BaseMasterViewModel
    {
        ...
        public static TicketViewModel FromDTO(TicketDTO dto)
        {
            ...
            if (dto.IsNotNull())
            {
                ...
                ticketVM.AssignedTo.Key = dto.AssignedEmployeeID.ToString(); ;
                ticketVM.AssignedTo.Value = dto.AssignedEmployeeName;
                ...
                ticketVM.IsSendCustomerNotification = dto.IsSendCustomerNotification;
        ...
        public static TicketDTO ToDTO(TicketViewModel vm)
        {
            ...
            if (vm.IsNotNull())
            {
                ...
                ticketDTO.AssignedEmployeeID = vm.AssignedTo.IsNotNull() ? Convert.ToInt32(vm.AssignedTo.Key) : (long?)null;
                ...
                ticketDTO.IsSendCustomerNotification = vm.IsSendCustomerNotification;
