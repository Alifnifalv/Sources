...
namespace Eduegate.Service.Client
{
    public class AccountingTransactionServiceClient : BaseClient, IAccountingTransaction
    {
        ...
        {
            string uri = string.Concat(Service + "\\GetCustomerPendingInvoices?accountID=" + accountID+ "&branchID="+ branchID);
        ...
        {
            string uri = string.Concat(Service + "\\AddAccountTransactionReceivablesMaps");
            return ServiceHelper.HttpPostRequest(uri, AccountTransactionReceivablesMapDTOs) == "true" ? true : false;
        }
