...
namespace Eduegate.Service.Client
{
    public class CustomerServiceClient : BaseClient, ICustomer
    {
        ...
        public List<SupplierAccountEntitlmentMapsDTO> GetCustomerAccountMaps(string CustomerID)
        {
            string uri = string.Concat(service + "\\GetCustomerAccountMaps?CustomerID=" + CustomerID);
            return ServiceHelper.HttpGetRequest<List<SupplierAccountEntitlmentMapsDTO>>(uri);
        }
        public List<SupplierAccountEntitlmentMapsDTO> SaveCustomerAccountMaps(List<SupplierAccountEntitlmentMapsDTO> SupplierAccountMapsDTOs)
        {
