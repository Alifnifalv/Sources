...
namespace Eduegate.Services.Client.Shools
{
    public class SchoolServiceClient : BaseClient, ISchoolService
    {
        ...
        void ISchoolService.DeleteTimeTableEntry(long timeTableAllocationID)
        {
            throw new NotImplementedException();
        }
        ...
        TransportCancellationDTO ISchoolService.GetStudentTransportCancellationDetails(long studentID)
        {
            throw new NotImplementedException();
        }

        OperationResultDTO ISchoolService.RevertTransportCancellation(long RequestIID)
        {
            throw new NotImplementedException();
        }
        ...
        List<NotificationAlertsDTO> ISchoolService.GetNotificationAlerts(long loginID, int page, int pageSize)
        {
            throw new NotImplementedException();
        }
        ...
        OperationResultDTO ISchoolService.GenerateTimeTable(TimeTableAllocationDTO timeTableLog)
        {
            throw new NotImplementedException();
        }
        ...
        List<KeyValueDTO> ISchoolService.GetAcademicYearBySchool(int schoolID, bool? isActive)
        {
            throw new NotImplementedException();
        }
        ...
        List<KeyValueDTO> ISchoolService.GetAcademicYearBySchoolForApplications(int schoolID, bool? isActive)
        {
            throw new NotImplementedException();
        }

        List<KeyValueDTO> ISchoolService.GetWeekDayByDate(string date) 
        { 
            throw new NotImplementedException(); 
        }

        List<KeyValueDTO> ISchoolService.GetSetupScreens()
        {
            throw new NotImplementedException();
        }
        ...
        List<AgendaDTO> ISchoolService.GetStudentSubjectWiseAgendas(long loginID, long subjectID, string date)
        {
            throw new NotImplementedException();
        }
    }
