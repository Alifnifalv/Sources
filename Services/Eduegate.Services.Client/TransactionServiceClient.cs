...
namespace Eduegate.Service.Client
{
    public class TransactionServiceClient : BaseClient, ITransaction
    {
        ...
        public TransactionDetailDTO CheckAvailibilityBundleItem(long branchID, List<TransactionDetailDTO> transactions)
        {
            ...
            return ServiceHelper.HttpGetRequest<TransactionDetailDTO>(uri);
        }
        ...
        TransactionDetailDTO ITransaction.CheckAvailibilityBundleItem(long branchID, List<TransactionDetailDTO> transactions)
        {
            throw new NotImplementedException();
        }
