...
{
    [DataContract]
    public class LmsDTO : BaseMasterDTO
    {
        public LmsDTO()
        {
            SignupSlotMaps = new List<LmsSlotMapDTO>();
            SignupAudienceMaps = new List<LmsAudienceMapDTO>();
        }
        ...
        [DataMember]
        public List<LmsSlotMapDTO> SignupSlotMaps { get; set; }

        [DataMember]
        public List<LmsAudienceMapDTO> SignupAudienceMaps { get; set; }
