...
{
    [DataContract]
    public class SubjectMarkEntryDTO : Eduegate.Framework.Contracts.Common.BaseMasterDTO
    {
        public SubjectMarkEntryDTO()
        {
            Exam = new KeyValueDTO();
            Class = new KeyValueDTO();
            Section = new KeyValueDTO();
            Subject = new KeyValueDTO();
            SubjectMarkEntryDetails = new List<SubjectMarkEntryDetailDTO>();
        ...
        [DataMember]
        public List<SubjectMarkEntryDetailDTO> SubjectMarkEntryDetails { get; set; }
