...
{  
    ...
    {       
        ...
        [DataMember]
        public EmployeeLSProvisionHeadDTO EmployeeLSProvisionHead { get; set; }

        [DataMember]
        public EmployeeESBProvisionHeadDTO EmployeeESBProvisionHead { get; set; }

        [DataMember]
        public List<LSESBProvisionDetailDTO> LSESBProvisionDetailList { get; set; }
