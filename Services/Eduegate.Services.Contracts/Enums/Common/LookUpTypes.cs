...
namespace Eduegate.Services.Contracts.Enums
{
    ...
    public enum LookUpTypes
    {
        ...
        BankShortNames = 3829,
        [EnumMember]
        StopEntryStatus = 3830,
        [EnumMember]
        LoanTypes = 3831,
        [EnumMember]
        LoanStatus = 3832,
        [EnumMember]
        LoanEntryStatus = 3833,
        [EnumMember]
        Quotations = 3834,
        [EnumMember]
        BookType = 3835,
        ...
        AssetCategory = 401,
        [EnumMember]
        AsstEntryManualDocumentStatuses = 402,
        [EnumMember]
        AsstEntryPurchaseDocumentStatuses = 403, 
        [EnumMember]
        AssetDepreciationDocumentStatuses = 404,
        [EnumMember]
        AssetDisposalDocumentStatuses = 405,
        [EnumMember]
        AssetTransferRequestDocumentStatuses = 406,
        [EnumMember]
        AssetTransferIssueDocumentStatuses = 407,
        [EnumMember]
        AssetTransferReceiptDocumentStatuses = 408,
        [EnumMember]
        StaffLedgerAccounts = 409,
        [EnumMember]
        ExpenseLedgerAccounts = 410,
        [EnumMember]
        ProvisionLedgerAccounts = 411 ,        
        [EnumMember]
        PendingInvoices
    }
}