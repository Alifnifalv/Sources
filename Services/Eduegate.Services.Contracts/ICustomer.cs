...
namespace Eduegate.Services.Contracts
{
    ...
    public interface ICustomer
    {
        ...
        List<SupplierAccountEntitlmentMapsDTO> GetCustomerAccountMaps(string CustomerID);

        List<SupplierAccountEntitlmentMapsDTO> SaveCustomerAccountMaps(List<SupplierAccountEntitlmentMapsDTO> SupplierAccountMapsDTOs);
