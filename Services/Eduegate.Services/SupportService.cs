...
namespace Eduegate.Services
{
    public class SupportService : BaseService, ISupportService
    {
        ...
        {
            return TicketingMapper.Mapper(CallContext).GetSupportActionsByReferenceTypeID(ticketReferenceTypeID);
        }

        public List<KeyValueDTO> GetSupportSubCategoriesByCategoryID(int? supportCategoryID)
        {
            return SupportCategoryMapper.Mapper(CallContext).GetSupportSubCategoriesByCategoryID(supportCategoryID);
        }
