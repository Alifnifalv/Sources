...
{
    public class AccountDocumentTypesViewMap : EntityTypeConfiguration<AccountDocumentTypesView>
    {
        public AccountDocumentTypesViewMap()
        {
            // Primary Key
            ...
            this.ToTable("AccountDocumentTypesView", "mutual");
