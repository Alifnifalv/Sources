...
namespace Eduegate.Domain.Entity.Models.Mapping
{
    public class ContactMap : EntityTypeConfiguration<Contact>
    {
        public ContactMap()
        {
            ...
            this.Property(t => t.IntlCity)
                .HasMaxLength(200);

            this.Property(t => t.IntlArea)
                .HasMaxLength(200);
            ...
            this.Property(t => t.IntlCity).HasColumnName("IntlCity");
            this.Property(t => t.IntlArea).HasColumnName("IntlArea");
        }
    }
}
