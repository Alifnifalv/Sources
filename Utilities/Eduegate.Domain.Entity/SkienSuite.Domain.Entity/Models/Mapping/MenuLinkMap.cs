...
namespace Eduegate.Domain.Entity.Models.Mapping
{
    public class MenuLinkMap : EntityTypeConfiguration<MenuLink>
    {
        public MenuLinkMap()
        {
            ...
            this.Property(t => t.ActionLink1)
                .HasMaxLength(500);

            this.Property(t => t.ActionLink2)
                .HasMaxLength(500);

            this.Property(t => t.ActionLink3)
                .HasMaxLength(500);
            ...
            // Relationships
            this.HasOptional(t => t.MenuLink1)
                .WithMany(t => t.MenuLinks1)
                .HasForeignKey(d => d.ParentMenuID);
            this.HasOptional(t => t.MenuLinkType)
                .WithMany(t => t.MenuLinks)
