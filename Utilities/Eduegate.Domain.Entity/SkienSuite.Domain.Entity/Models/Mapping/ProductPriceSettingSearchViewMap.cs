...
{
    public class ProductPriceSettingSearchViewMap : EntityTypeConfiguration<ProductPriceSettingSearchView>
    {
        public ProductPriceSettingSearchViewMap()
        {
            // Primary Key
            ...
            this.ToTable("ProductPriceSettingSearchView", "catalog");
