...
{
    public class ProductSearchSummaryViewMap : EntityTypeConfiguration<ProductSearchSummaryView>
    {
        public ProductSearchSummaryViewMap()
        {
            // Primary Key
            ...
            this.ToTable("ProductSearchSummaryView", "catalog");
