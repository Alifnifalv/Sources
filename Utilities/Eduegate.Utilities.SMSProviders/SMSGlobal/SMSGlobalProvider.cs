...
namespace Eduegate.Utilities.SMSProviders.SMSGlobal
{
    public class SMSGlobalProvider
    {
        ...
        private static string SMSGlobalData(string username, string password, string source, string destination, string text)
        {
