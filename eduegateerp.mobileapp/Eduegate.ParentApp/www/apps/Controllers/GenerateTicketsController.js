app.controller("GenerateTicketsController", [
  ...
  function (
    ...
    $scope.OnFacultyTypeChanges = function (selectedFacultyType) {
      ...
      if (
        facultyType.toLowerCase().includes("principal") &&
        !facultyType.toLowerCase().includes("vice")
      ) {
        ...
        facultyType.toLowerCase().includes("class") &&
        facultyType.toLowerCase().includes("teacher")
      ) {
        $scope.FillHeadTeacher();
      } else if (
        facultyType.toLowerCase().includes("class") &&
        facultyType.toLowerCase().includes("coordinator")
      ) {
        $scope.FillClassCoordinator();
      } else if (
        facultyType.toLowerCase().includes("associate") &&
        facultyType.toLowerCase().includes("teacher")
      ) {
        $scope.FillAssociateTeacher();
      } else if (
        facultyType.toLowerCase().includes("other") &&
        facultyType.toLowerCase().includes("teacher")
      ) {
