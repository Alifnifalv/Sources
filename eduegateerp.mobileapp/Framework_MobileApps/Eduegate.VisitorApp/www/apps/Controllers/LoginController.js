app.controller("LoginController", [
  ...
  function (
      ...
      if ($scope.loginForm.$valid) {
        $http({
          ...
          data: {
            ...
            'PassportNumber': $scope.LoginType == 'PassportNumber' ? $scope.user.PassportNumber : null,
          },
          headers: {
    ...
    $scope.FillUserDetails = function () {
      $http({
          method: "GET",
          url: schoolService + "/GetVisitorDetails?QID=" + $scope.QID + "&passportNumber=" + $scope.PassportNumber,
          headers: {
              Accept: "application/json;charset=UTF-8",
              "Content-type": "application/json; charset=utf-8",
              CallContext: null,
