...
namespace Eduegate.Application.Mvc
{
    public class BaseController : Controller
    {
        ...
        protected void ResetCallContext(CallContext callContext = null)
        {
            ...
            //    CallContext.CurrencyCode = CallContext.CurrencyCode.IsNotNullOrEmpty() ? CallContext.CurrencyCode : new Domain.Setting.SettingBL().GetSettingValue<string>("DefaultCurrencyCode");
