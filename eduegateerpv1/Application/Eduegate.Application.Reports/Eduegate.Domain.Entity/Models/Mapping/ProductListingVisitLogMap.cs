...
{
    public class ProductListingVisitLogMap : EntityTypeConfiguration<ProductListingVisitLog>
    {
        public ProductListingVisitLogMap()
        {
            // Primary Key
            ...
            this.ToTable("ProductListingVisitLog");
