...
{
    public class ProductVisitLogIntlMap : EntityTypeConfiguration<ProductVisitLogIntl>
    {
        public ProductVisitLogIntlMap()
        {
            // Primary Key
            this.HasKey(t => t.ProductVisitLogIntlID);
            ...
            this.ToTable("ProductVisitLogIntl");
            this.Property(t => t.ProductVisitLogIntlID).HasColumnName("ProductVisitLogIntlID");
