...
{
    public class vwProductListNewPreviewMap : EntityTypeConfiguration<vwProductListNewPreview>
    {
        public vwProductListNewPreviewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.ProductColor, t.BrandID, t.BrandCode, t.BrandPosition, t.ProductAvailableQuantity, t.ProductDescription, t.ProductDetails, t.IsVertual, t.IsPhysical, t.IsNextDay, t.IsProductVoucher, t.MultiPrice, t.ProductManager, t.SupplierName });
            ...
            this.Property(t => t.ProductManager)
                .IsRequired()
                .HasMaxLength(255);
            ...
            this.ToTable("vwProductListNewPreview");
