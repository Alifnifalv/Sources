...
{
    public class vwProductListSearchListing_Search_1Map : EntityTypeConfiguration<vwProductListSearchListing_Search_1>
    {
        public vwProductListSearchListing_Search_1Map()
        {
            // Primary Key
            ...
            this.ToTable("vwProductListSearchListing_Search_1");
