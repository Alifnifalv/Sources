...
namespace Eduegate.Domain.Mappers.UserDevice
{
    public class UserDeviceMapMapper : DTOEntityDynamicMapper
    {
        ...
        private UserDeviceMapDTO ToDTO(long IID)
        {
            ...
            {
                var entity = dbContext.UserDeviceMaps.FirstOrDefault(x => x.UserDeviceMapIID == IID);
        ...
        public override string SaveEntity(BaseMasterDTO dto)
        {
            ...
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                else
                {
                    ...
                    var deviceList = dbContext.UserDeviceMaps.Where(x => x.LoginID == entity.LoginID && x.UserDeviceMapIID != entity.UserDeviceMapIID && x.IsActive == true).ToList();
