...
namespace Eduegate.Domain.Repository
{
    public class MenuRepository
    {
        ...
        public List<MenuLink> GetMenusByType(Eduegate.Services.Contracts.Enums.MenuLinkTypes menuLinkType, long? parentMenuID = null, string languageCode = "en")
        {
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                {
                    menLinks = dbContext.MenuLinks
                        .Include("MenuLinkCultureDatas")
        ...
        public string GetCategoryTree(int siteID, string categoryCode)
        {
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                return dbContext.Database.SqlQuery<string>(searchQuery).FirstOrDefault();
            }
        }
        ...
        public List<MenuLinkCategoryMap> GetMenuLinkCategoryMaps(Int64 menuLinkID)
        {
            ...
            {
                menuLinkCategoryMapList = db.MenuLinkCategoryMaps.Where(a => a.MenuLinkID == menuLinkID).OrderBy(b => b.SortOrder).ToList<MenuLinkCategoryMap>();
            }
