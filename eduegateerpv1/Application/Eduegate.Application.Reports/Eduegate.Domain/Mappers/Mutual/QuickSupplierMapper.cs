...
namespace Eduegate.Domain.Mappers.Mutual
{
    public class QuickSupplierMapper : DTOEntityDynamicMapper
    {
        ...
        public override string SaveEntity(BaseMasterDTO dto)
        {
            ...
            var mainAccountID = new SettingRepository().GetSettingDetail("PAYABLEGLMAINACC", _context.CompanyID.Value);
            new AccountingRepository().AddOrUpdateSubAccount(AccountEntity(toDto, long.Parse(mainAccountID.SettingValue)), null, supplierID.SupplierIID);
        ...
        public Supplier ToEntity(SupplierDTO Supplier)
        {
            ...
            entity.VendorCR = Supplier.VendorCR;
