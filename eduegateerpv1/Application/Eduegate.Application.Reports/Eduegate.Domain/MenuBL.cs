...
namespace Eduegate.Domain
{
    public class MenuBL
    {
        ...
        public List<MenuDTO> GetERPMenu(Eduegate.Services.Contracts.Enums.MenuLinkTypes menuLinkType)
        {
            var dtos = new List<MenuDTO>();

            if (_context == null) return dtos;
            var menus = menuRepository.GetMenusByType(menuLinkType, null, _context.LanguageCode);
