...
namespace Eduegate.Domain
{
    public class NotificationBL
    {
        ...
        {
            var mobileNumberPrefix = Eduegate.Framework.Extensions.ConfigurationExtensions.GetAppConfigValue("DefaultMobilePrefix");
            var localnumberSize = Eduegate.Framework.Extensions.ConfigurationExtensions.GetAppConfigValue<int>("DefaultLocalNumberSize");
