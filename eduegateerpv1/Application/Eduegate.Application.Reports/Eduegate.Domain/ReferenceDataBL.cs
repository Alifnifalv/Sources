...
namespace Eduegate.Domain
{
    public class ReferenceDataBL
    {
        ...
        /// <summary>
        /// Get paaport issue country masters
        /// </summary>
        /// <returns>List of passport issue country masters</returns>
        ...
        /// </summary>
        /// <returns>List of shipping address</returns>
        ...
        /// Get billing address
        /// </summary>
        /// <returns>List of billing address</returns>
        ...
        public List<KeyValueDTO> GetLookUpData(Eduegate.Services.Contracts.Enums.LookUpTypes lookType, string searchText = "", int dataSize = 0, int optionalId = 0)
        {
            ...
            switch (lookType)
            {
                ...
                case Services.Contracts.Enums.LookUpTypes.ChartMonthAndYearPeriod:
                    {
                        var startDate = new SettingBL().GetSettingValue<DateTime>("StartDate", _callContext.CompanyID.Value, DateTime.Now.Date);
                ...
                case Services.Contracts.Enums.LookUpTypes.AssetCode:
                    ...
                    break;
                case Services.Contracts.Enums.LookUpTypes.AssetEntryDocumentStatuses:
                    {
                        ...
                        foreach (var entity in entities)
                        {
                            keyValues.Add(new KeyValueDTO() { Key = entity.DocumentReferenceStatusMapID.ToString(), Value = entity.DocumentStatus.StatusName });
                        }
                    }
                    break;
                case Services.Contracts.Enums.LookUpTypes.AssetDepreciationDocumentStatuses:
                    ...
                    break;
                case Services.Contracts.Enums.LookUpTypes.AssetRemovalDocumentStatuses:
                    {
                ...
                case Services.Contracts.Enums.LookUpTypes.TreatmentGroup:
                    ...
                    //        {
                    //            var repository = new EntiyRepository<TreatmentGroup, EduegatedERP_SalonContext>(dbContext);

                    //            foreach (var entity in repository.GetAll().OrderBy(a=> a.Description))
                    //            {
                ...
                case Services.Contracts.Enums.LookUpTypes.TreatmentType:
                    ...
                    //        using (EduegatedERP_SalonContext dbContext = new EduegatedERP_SalonContext())
                    //        {
                    //            var repository = new EntiyRepository<TreatmentType, EduegatedERP_SalonContext>(dbContext);
                ...
                case Services.Contracts.Enums.LookUpTypes.AvailableFor:
                    ...
                    //        using (EduegatedERP_SalonContext dbContext = new EduegatedERP_SalonContext())
                    //        {
                    //            var repository = new EntiyRepository<ServiceAvailable, EduegatedERP_SalonContext>(dbContext);
                ...
                case Services.Contracts.Enums.LookUpTypes.PricingType:
                    ...
                    //        using (EduegatedERP_SalonContext dbContext = new EduegatedERP_SalonContext())
                    //        {
                    //            var repository = new EntiyRepository<PricingType, EduegatedERP_SalonContext>(dbContext);
                ...
                case Services.Contracts.Enums.LookUpTypes.ExtraTimeType:
                    ...
                    //        using (EduegatedERP_SalonContext dbContext = new EduegatedERP_SalonContext())
                    //        {
                    //            var repository = new EntiyRepository<ExtraTimeType, EduegatedERP_SalonContext>(dbContext);
        ...
        public static DepartmentDTO FromDepartmentEntity(Department entity)
        {
        ...
        public static Department ToDepartmentEntity(DepartmentDTO dto, CallContext callContext)
        {
        ...
        /// <summary>
        /// get all list of Delivery Method
        /// </summary>
        /// <returns> all Delivery Method </returns>
        ...
        {
            var currencyID = _callContext != null && _callContext.CompanyID.HasValue ? int.Parse(new SettingRepository().GetSettingDetail("DEFAUTCURRENCY", _callContext.CompanyID.Value).SettingValue)
                : int.Parse(new SettingRepository().GetSettingDetail("DEFAUTCURRENCY").SettingValue);
        ...
        {
            var defaultCurrency = _callContext != null && _callContext.CompanyID.HasValue ? new SettingRepository().GetSettingDetail("DEFAUTCURRENCY", _callContext.CompanyID.Value)
                : new SettingRepository().GetSettingDetail("DEFAUTCURRENCY");
        ...
        public List<PaymentMethodDTO> GetPaymentMethods(int siteID)
        {
            ...
            var paymentMethods = referenceDataRepository.GetPaymentBySitePaymentGroup(siteID, new CustomerBL(_callContext).CustomerVerificatonCheck(Convert.ToInt64(carts.CustomerID)), !carts.IsIntlCart, carts.IsEmailDeliveryInCart);
