...
namespace Eduegate.TransactionEgine.Accounting
{
    public class AccountingBase
    {
        ...
        public bool AddReceivable(ViewModels.AccountTransactionHeadViewModel transHead, long? AccountId, decimal? totalPaidAmount, bool debitOrCredit)
        {
            ...
            receivableEntity.TransactionHeadReceivablesMaps = new List<TransactionHeadReceivablesMapDTO>() { new TransactionHeadReceivablesMapDTO { HeadID = transHead.AccountTransactionHeadIID } };
