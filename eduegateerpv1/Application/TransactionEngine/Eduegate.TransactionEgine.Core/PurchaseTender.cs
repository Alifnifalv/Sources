...
{
    public class PurchaseTender : TransactionBase, ITransactions
    {
        public PurchaseTender(Action<string> logError)
        {
            _logError = logError;
        }

        public DocumentReferenceTypes ReferenceTypes => Framework.Enums.DocumentReferenceTypes.PurchaseTender;
