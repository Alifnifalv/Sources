...
{
    public class SalesInvoice : TransactionBase, ITransactions
    {
        public SalesInvoice(Action<string> logError)
        {
            _logError = logError;
        }
        ...
        {
            get { return DocumentReferenceTypes.SalesInvoice; }
        }

        public void Process(TransactionHeadViewModel transaction)
        {
            WriteLog("SalesInvoice-Process started for TransactionID:" + transaction.HeadIID.ToString());
        ...
        private void ProcessNew(TransactionHeadViewModel transaction)
        {
            ...
            if (isSuccess)
            {
                WriteLog("Calling SalesInvoice-UpdateProductInventory");
        ...
        private bool RevertSalesTransaction(long transactionHeadID)
        {
            ...
            WriteLog("Calling SalesInvoice-RevertSalesTransaction for HeadID:" + transactionHeadID.ToString());
            bool isSuccess = false;
            ...
            isSuccess = new PurchaseInvoice(_logError).UpdateProductInventory(vm, DocumentReferenceTypes.PurchaseInvoice);
            return isSuccess;
        }       
