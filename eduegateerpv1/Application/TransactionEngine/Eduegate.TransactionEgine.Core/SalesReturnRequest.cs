...
{
    public class SalesReturnRequest : TransactionBase, ITransactions
    {
        public SalesReturnRequest(Action<string> logError)
        {
            _logError = logError;
        }
        ...
        {
            get { return Framework.Enums.DocumentReferenceTypes.SalesReturnRequest; }
        }
        ...
        public void Process(ViewModels.TransactionHeadViewModel transaction)
        {
            try
            {
                WriteLog("Processing Sales return request :" + transaction.HeadIID.ToString());
