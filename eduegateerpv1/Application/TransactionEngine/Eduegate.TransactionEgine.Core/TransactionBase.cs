...
namespace Eduegate.TransactionEngineCore
{
    public class TransactionBase
    {
        ...
        public bool UpdateBundleProductInventory(TransactionHeadViewModel transactions, decimal quantity, List<ProductBundleDTO> BundleItems, Eduegate.Framework.Enums.DocumentReferenceTypes referenceType, long? toBranchID = null)
        {
            WriteLog("Updating product inventory :" + transactions.HeadIID.ToString() + "-(" + transactions.TransactionDetails.Count.ToString() + ")");
