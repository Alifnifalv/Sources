...
{
    public class ProductNotificationIntlMap : EntityTypeConfiguration<ProductNotificationIntl>
    {
        public ProductNotificationIntlMap()
        {
            // Primary Key
            ...
            this.ToTable("ProductNotificationIntl");
