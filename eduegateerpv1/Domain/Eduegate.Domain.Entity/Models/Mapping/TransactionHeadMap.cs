...
namespace Eduegate.Domain.Entity.Models.Mapping
{
    public class TransactionHeadMap : EntityTypeConfiguration<TransactionHead>
    {
        public TransactionHeadMap()
        {
            ...
            this.Property(t => t.DiscountAmount).HasColumnName("DiscountAmount").HasPrecision(18, 3);
            ...
            this.Property(t => t.DeliveryCharge).HasColumnName("DeliveryCharge").HasPrecision(18, 3);
            ...
            this.Property(t => t.TotalLandingCost).HasColumnName("TotalLandingCost").HasPrecision(18, 3);
            this.Property(t => t.InvoiceLocalAmount).HasColumnName("InvoiceLocalAmount").HasPrecision(18, 3);
            this.Property(t => t.InvoiceForeignAmount).HasColumnName("InvoiceForeignAmount").HasPrecision(18, 3);
            // Relationships
            ...
            this.HasOptional(e => e.Employee1)
                .WithMany(e => e.TransactionHeads1)
            ...
            //this.HasMany(t => t.WorkflowTransactionHeadMaps)
            // .WithOptional(t => t.TransactionHead)
