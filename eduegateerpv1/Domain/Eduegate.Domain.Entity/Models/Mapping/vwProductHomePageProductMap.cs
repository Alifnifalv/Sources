...
{
    public class vwProductHomePageProductMap : EntityTypeConfiguration<vwProductHomePageProduct>
    {
        public vwProductHomePageProductMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.Position, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.BrandCode, t.ProductAvailableQuantity });
            ...
            this.ToTable("vwProductHomePageProducts");
