...
{
    public class vwProductListByBestSellerMap : EntityTypeConfiguration<vwProductListByBestSeller>
    {
        public vwProductListByBestSellerMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.ProductColor, t.BrandID, t.BrandCode, t.BrandPosition, t.ProductAvailableQuantity, t.ProductSoldQty, t.ProductNameBrand, t.NewArrival, t.DisableListing, t.ProductActive, t.ProductActiveAr });
            ...
            this.ToTable("vwProductListByBestSellers");
