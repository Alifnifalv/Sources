...
{
    public class vwProductListHomePageProductMap : EntityTypeConfiguration<vwProductListHomePageProduct>
    {
        public vwProductListHomePageProductMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.ProductColor, t.BrandID, t.BrandCode, t.BrandPosition, t.ProductAvailableQuantity, t.ProductDescription, t.ProductDetails, t.Position, t.ProductNameBrand });
            ...
            this.ToTable("vwProductListHomePageProducts");
