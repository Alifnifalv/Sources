...
{
    public class vwProductListNewMap : EntityTypeConfiguration<vwProductListNew>
    {
        public vwProductListNewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductID, t.ProductName, t.BrandNameEn, t.ProductPrice, t.ProductDiscountPrice, t.prodname, t.ProductColor, t.BrandID, t.BrandCode, t.BrandPosition, t.ProductAvailableQuantity, t.ProductDescription, t.ProductDetails, t.IsVertual, t.IsPhysical, t.IsNextDay, t.IsProductVoucher, t.MultiPrice, t.ProductNameAr, t.ProductActive, t.ProductActiveAr });
