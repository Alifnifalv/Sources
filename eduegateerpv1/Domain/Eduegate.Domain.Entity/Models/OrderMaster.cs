...
namespace Eduegate.Domain.Entity.Models
{
    public partial class OrderMaster
    {
        ...
        public Nullable<System.DateTime> PartialDeliveryDate { get; set; }
        public string PartialDeliveryRemarks { get; set; }
        ...
        public Nullable<decimal> cnExpressDeliveryCharges { get; set; }
        public Nullable<decimal> cnNextDayDeliveryCharges { get; set; }
        public Nullable<decimal> cnExpressDeliveryDiscount { get; set; }
        public Nullable<decimal> cnNextDayDeliveryDiscount { get; set; }
        public Nullable<decimal> cnActualNextdayDelivery { get; set; }
        public Nullable<decimal> cnActualExpressDeliveryCharge { get; set; }
        ...
        public string BillingJadda { get; set; }
        public string BillingTelephone2 { get; set; }
        public string RefIntlCity { get; set; }
        public string RefIntlArea { get; set; }
