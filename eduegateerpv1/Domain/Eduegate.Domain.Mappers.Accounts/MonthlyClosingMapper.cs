...
namespace Eduegate.Domain.Mappers.Accounts
{
    public class MonthlyClosingMapper : DTOEntityDynamicMapper
    {
        ...
        public List<FeeGeneralMonthlyClosingDTO> GetFeeGeneralMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                using (SqlConnection conn = new SqlConnection(_sBuilder.ConnectionString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("[account].[SPS_PC_FEE_GENERAL]", conn))
                    {
                        ...
                        adapter.SelectCommand.Parameters["@COMPANY_IDs"].Value = "1";
        ...
        public List<FeeGeneralMonthlyClosingDTO> GetFeeAccountCompareMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
            var listData = new List<FeeGeneralMonthlyClosingDTO>();
            using (var dbContext = new dbEduegateERPContext())
            {
        ...
        public List<InvoiceGeneralMonthlyClosingDTO> GetInventoryGeneralMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
        ...
        public List<FeeGeneralMonthlyClosingDTO> GetFeeCancelMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
            var listData = new List<FeeGeneralMonthlyClosingDTO>();
            using (var dbContext = new dbEduegateERPContext())
            {
        ...
        public List<InvoiceGeneralMonthlyClosingDTO> GetInventoryCancelMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
            var listData = new List<InvoiceGeneralMonthlyClosingDTO>();
            using (var dbContext = new dbEduegateERPContext())
            {
        ...
        public List<AccountsMonthlyClosingDTO> GetAccountCancelMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
        ...
        public List<StockMonthlyClosingDTO> GetStockMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
        ...
        public List<FeeMismatchedMonthlyClosingDTO> GetFeeMismatchedMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
        ...
        public List<AccountMismatchedMonthlyClosingDTO> GetAccountsMismatchedMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
        ...
        public List<AccountsGeneralMonthlyClosingDTO> GetAccountsGeneralMonthlyClosing(DateTime? startDate, DateTime? endDate)
        {
            ...
            using (var dbContext = new dbEduegateERPContext())
            {
                ...
                using (SqlConnection conn = new SqlConnection(_sBuilder.ConnectionString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("account.SPS_PC_SAVE_TRANSACTIONS", conn))
                    {
                        ...
                        adapter.SelectCommand.Parameters.Add(new SqlParameter("@SDATE", SqlDbType.DateTime));
                        adapter.SelectCommand.Parameters["@SDATE"].Value = System.DateTime.Now;

                        adapter.SelectCommand.Parameters.Add(new SqlParameter("@EDATE", SqlDbType.DateTime));
                        adapter.SelectCommand.Parameters["@EDATE"].Value = System.DateTime.Now;
        ...
        public DateTime? GetMonthlyClosingDate()
        {
            ...
            {
                return _sContext.PeriodClosingTranHeads.Max(x => x.ToDate).GetValueOrDefault();
            }
        }
