...
namespace Eduegate.Domain.Repository
{
    public class MutualRepository
    {
        ...
        public List<Comment> GetChats(long entityTypeID, long? fromLoginID, long? toLoginID)
        {
            using (dbEduegateERPContext db = new dbEduegateERPContext())
            {
               ...
               .Where(c => c.EntityTypeID == entityTypeID &&
                          ((c.FromLoginID == fromLoginID && c.ToLoginID == toLoginID) ||  // original direction
                           (c.FromLoginID == toLoginID && c.ToLoginID == fromLoginID)))  // reversed direction
               .AsNoTracking()
               .ToList();
