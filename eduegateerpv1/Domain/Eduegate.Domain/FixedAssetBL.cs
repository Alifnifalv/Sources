...
namespace Eduegate.Domain
{
    public class FixedAssetBL
    {
        ...
        public AssetDTO ToAssetDTO(Asset entity)
        {
            ...
            {
                dto.AccumulatedDepGLAccount = new Eduegate.Framework.Contracts.Common.KeyValueDTO() { Key = entity.AccumulatedDepGLAccID.ToString(), Value = entity.AccumulatedDepGLAcc.AccountName };
            }
            if (entity.AssetGlAcc != null)
            {
                dto.AssetGlAccount = new Eduegate.Framework.Contracts.Common.KeyValueDTO() { Key = entity.AssetGlAccID.ToString(), Value = entity.AssetGlAcc.AccountName };
            }
            if (entity.DepreciationExpGLAcc != null)
            {
                dto.DepreciationExpGLAccount = new Eduegate.Framework.Contracts.Common.KeyValueDTO() { Key = entity.DepreciationExpGLAccId.ToString(), Value = entity.DepreciationExpGLAcc.AccountName };
            }
