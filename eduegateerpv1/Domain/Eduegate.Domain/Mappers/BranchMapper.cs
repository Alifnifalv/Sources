    ...
    public class BranchMapper : IDTOEntityMapper<BranchDTO, Branch>
    {
        ...
        public BranchDTO ToDTO(Branch entity, bool bindRelations)
        {
            ...
            if (bindRelations)
            {
                ...
                {
                    branch.PriceLists.Add(new PriceListDetailDTO()
                    {
                        ProductPriceListBranchMapIID = price.ProductPriceListBranchMapIID,
                        PriceListID = price.ProductPriceListID.Value,
                        PriceDescription = price.ProductPriceList.PriceDescription
                    });
                }
            }
            ...
            if (bindRelations)
            {
                ...
                {
                    branch.DocumentTypeMaps.Add(new DocumentTypeDetailDTO()
                    {
                        BranchDocumentTypeMapIID = doc.BranchDocumentTypeMapIID,
                        DocumentTypeID = doc.DocumentTypeID.Value,
                        DocumentName = doc.DocumentType.TransactionTypeName
                    });
                }
            }
        ...
        public Branch ToEntity(BranchDTO dto)
        {
            ...
            if (dto.PriceLists != null)
            {
                ...
                {
                    entity.ProductPriceListBranchMaps.Add(new ProductPriceListBranchMap()
                    {
                        ProductPriceListBranchMapIID = price.ProductPriceListBranchMapIID,
                        ProductPriceListID = price.PriceListID,
                        BranchID = dto.BranchIID
                    });
                }
            }
            ...
            if (dto.DocumentTypeMaps != null)
            {
                ...
                {
                    entity.BranchDocumentTypeMaps.Add(new BranchDocumentTypeMap()
                    {
                        BranchDocumentTypeMapIID = doc.BranchDocumentTypeMapIID,
                        DocumentTypeID = int.Parse(doc.DocumentTypeID.ToString()),
                        BranchID = dto.BranchIID
                    });
                }
            }
