...
namespace EntityGenerator.Core.Data
{
    ...
    public partial class Employee
    {
        public Employee()
        {
            ...
            TicketAssingedEmployees = new HashSet<Ticket>();
            TicketEmployees = new HashSet<Ticket>();
            TicketManagerEmployees = new HashSet<Ticket>();
        ...
        [InverseProperty("AssingedEmployee")]
        public virtual ICollection<Ticket> TicketAssingedEmployees { get; set; }
        [InverseProperty("Employee")]
        public virtual ICollection<Ticket> TicketEmployees { get; set; }
        [InverseProperty("ManagerEmployee")]
        public virtual ICollection<Ticket> TicketManagerEmployees { get; set; }
        [InverseProperty("Staff")]
