...
{
    [Table("Trantail", Schema = "account")]
    [Index("AccountID", Name = "IDX_Trantail_AccountID")]
    [Index("AccountID", Name = "idx_TrantailAccountID")]
    [Index("AccountID", Name = "idx_TrantailAccountIDInclAll")]
    public partial class Trantail
    {
