...
namespace Eduegate.ERP.Admin.Areas.Accounts.Controllers
{
    public class AccountEntryController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.AccountEntry);
        ...
        [HttpPost]
        public JsonResult Save(AccountViewModel vm)
        {
