...
namespace Eduegate.ERP.Admin.Areas.Accounts.Controllers
{
    public class ChartOfAccountController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.ChartOfAccount);
        ...
        [HttpPost]
        public JsonResult Save(ChartOfAccountViewModel vm)
        {
