...
namespace Eduegate.ERP.Admin.Areas.Catalogs.Controllers
{
    public class PriceController : BaseSearchController
    {
        ...
        private static string dateTimeFormat { get { return ConfigurationExtensions.GetAppConfigValue("DateTimeFormat"); } }
        // GET: Price
        ...
        public ActionResult List()
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.Price);
        ...
        public JsonResult CreatePriceInformationDetail(ProductPriceViewModel productPriceInfo)
        {
            ...
            catch (Exception exception)
            {
                ...
                return Json(new { IsError = !isSuccessful, Response = request, UserMessage = exception.Message.ToString() }, JsonRequestBehavior.AllowGet);
            }

            return Json(new { IsError = !isSuccessful, PriceModel = productPriceInfo }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetProductPriceList(string searchText)
        {
            ...
            try
            {
                ...
                var posProductItems = ClientFactory.ProductCatalogServiceClient(CallContext).GetProductListWithSKU(searchText, int.Parse(base.PageSize));
        ...
        public JsonResult UpdateSKUProductPrice(List<ProductPriceSKUViewModel> productPriceSKUModelList)
        {
            ...
            {
                LogHelper<AccountController>.Fatal(exception.Message.ToString(), exception);
                return Json(new { IsError = !result, MapList = productPriceSKUDTOList, UserMessage = exception.Message.ToString() }, JsonRequestBehavior.AllowGet);
            }

            return Json(new { IsError = !result, MapList = productPriceSKUDTOList, Message = " Sucessfully saved." }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetProductPriceSKU(long id)
        {
            ...
            return Json(new { ProductPriceSKUViewModel = listlistProductPriceSKUViewModel }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetProductPriceListTypes()
        {
            ...
            return Json(new { ProductPriceListTypeViewModel = lists }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetProductPriceListLevels()
        {
            ...
            return Json(new { ProductPriceListLevelViewModel = lists }, JsonRequestBehavior.AllowGet);
        }
