...
namespace Eduegate.ERP.Admin.Areas.Catalogs.Controllers
{
    public class ProductPropertyController : BaseSearchController
    {
        ...
        public ActionResult List()
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList(Eduegate.Services.Contracts.Enums.SearchView.ProductProperty);
        ...
        [HttpPost]
        public JsonResult Save(PropertiesViewModel vm)
        {
