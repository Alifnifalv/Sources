...
namespace Eduegate.ERP.Admin.Areas.Catalogs.Controllers
{
    public class ProductSKUTagController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.ProductSKUTag);
