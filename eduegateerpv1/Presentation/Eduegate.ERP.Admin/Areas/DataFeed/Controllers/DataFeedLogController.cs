...
namespace Eduegate.ERP.Admin.Areas.DataFeed.Controllers
{
    public class DataFeedLogController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.DataFeedLog);
        ...
        public ActionResult ChildList(long ID)
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList(Services.Contracts.Enums.SearchView.DataFeedDetail);
