...
namespace Eduegate.ERP.Admin.Areas.HR.Controllers
{
    public class JobOpeningController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.JobOpening);
