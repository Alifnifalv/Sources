...
{
    public class SalesInvoiceLiteController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.SalesInvoice);
        ...
        {
            var vm = new SalesInvoiceLiteViewModel()
            {
            ...
            //SalesInvoiceLiteMasterViewModel SalesInvoiceLiteViewModel = new SalesInvoiceLiteMasterViewModel();
            //SalesInvoiceLiteViewModel.DocumentReferenceTypeID = Services.Contracts.Enums.DocumentReferenceTypes.SalesInvoice;
            //vm.MasterViewModel = SalesInvoiceLiteViewModel;
        ...
        {
            var vm = TransactionViewModel.FromSalesInvoiceLiteDTO(ClientFactory.TransactionServiceClient(CallContext).GetTransaction(ID, true, false));
            if (vm != null)
            {
                vm.DetailViewModel.Add(new SalesInvoiceLiteDetailViewModel());
            }       
            return Json(vm, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult Save(SalesInvoiceLiteViewModel vm)
        {
            try
            {
                var updatedVM = new SalesInvoiceLiteViewModel();
                ...
                if (vm != null)
                {
                    ...
                    var result = ClientFactory.TransactionServiceClient(CallContext).SaveTransactions(TransactionViewModel.ToSalesInvoiceLiteDTO(vm));

                    updatedVM = TransactionViewModel.FromSalesInvoiceLiteDTO(result);
                ...
                if (updatedVM != null)
                {
                    updatedVM.DetailViewModel.Add(new SalesInvoiceLiteDetailViewModel());
                }
        ...
        public ActionResult GenerateInvoiceScreenForJob(long ID = 0)
        {
            try
            {
                ...
                viewModel.MasterViewModel = new SalesInvoiceLiteMasterViewModel();
                viewModel.DetailViewModel = new SalesInvoiceLiteDetailViewModel();
                ...
                {
                    viewModel.Model = new SalesInvoiceLiteViewModel()
                    {
                ...
                {
                    List<SalesInvoiceLiteDetailViewModel> salesInvoiceDetails = new List<SalesInvoiceLiteDetailViewModel>();
                    ...
                    if (jobDetail.IsNotNull())
                    {
                        ...
                        {
                            SalesInvoiceLiteDetailViewModel sidVM = null;

                            foreach (JobOperationDetailDTO jodDTO in jobDetail.Detail)
                            {
                                sidVM = new SalesInvoiceLiteDetailViewModel();
                    ...
                    var SalesInvoiceLiteMasterViewModel = new SalesInvoiceLiteMasterViewModel()
                    {
                        JobEntryHeadID = ID,
                    ...
                    //SalesInvoiceLiteMasterViewModel.DeliveryDetails.OrderContactMapID = 0;
                    //if (transactionDetail.OrderContactMaps.IsNotNull() && transactionDetail.OrderContactMaps.Count > 0)
                    //{
                    //    SalesInvoiceLiteMasterViewModel.DeliveryDetails = DeliveryAddressViewModel.FromOrderContactDTOToVM(transactionDetail.OrderContactMaps.Where(a => a.IsShippingAddress == true).FirstOrDefault());
                    //}

                    viewModel.Model = new SalesInvoiceLiteViewModel()
                    {
                        DetailViewModel = salesInvoiceDetails,
                        MasterViewModel = SalesInvoiceLiteMasterViewModel,
                    };
                }
            ...
            {
                Eduegate.Logger.LogHelper<SalesInvoiceLiteController>.Fatal(ex.Message.ToString(), ex);
                return Json(new { IsError = true, UserMessage = ex.Message }, JsonRequestBehavior.AllowGet);
            }
        }

        public SalesInvoiceLiteViewModel GetTransactionByJobEntryHeadId(long jobEntryHeadId)
        {
            var vm = TransactionViewModel.FromSalesInvoiceLiteDTO(ClientFactory.TransactionServiceClient(CallContext).GetTransactionByJobEntryHeadId(jobEntryHeadId));
            if (vm != null)
            {
                vm.DetailViewModel.Add(new SalesInvoiceLiteDetailViewModel());
            }
        ...
        public JsonResult SaveTransactions(TransactionViewModel transactionModel)
        {
            ...
            {
                Eduegate.Logger.LogHelper<SalesInvoiceLiteController>.Fatal(exception.Message.ToString(), exception);
