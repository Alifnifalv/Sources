...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    public class SalesOrderLiteController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.SalesOrderLite);
        ...
        [HttpPost]
        public JsonResult Save(SalesOrderLiteViewModel vm)
        {
            try
            {
