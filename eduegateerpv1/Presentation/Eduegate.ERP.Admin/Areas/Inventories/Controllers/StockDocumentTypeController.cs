...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    public class StockDocumentTypeController : BaseSearchController
    {
        ...
        {
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.StockDocumentType);
        ...
        {
            return Json(new DocumentTypeViewModel(), JsonRequestBehavior.AllowGet);
        }
