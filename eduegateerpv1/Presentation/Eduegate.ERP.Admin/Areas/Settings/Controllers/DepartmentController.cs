...
namespace Eduegate.ERP.Admin.Areas.Settings.Controllers
{
    public class DepartmentController : BaseSearchController
    {
        ...
        public ActionResult List()
        {
            ...
            var metadata = ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.Department);
        ...
        [HttpPost]
        public JsonResult Save(DepartmentViewModel vm)
        {
