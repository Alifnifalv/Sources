...
! function(a) {
    ...
    var c = function(c, d) {
        var e, f, g, h, i, j, k, l = {},
            ...
            x = function(a) {
                var c, e, f, g, h, i = !1;
                return void 0 !== b.tz && void 0 !== d.timeZone && null !== d.timeZone && "" !== d.timeZone && (i = !0), void 0 === a || null === a ? c = i ? b().tz(d.timeZone) : b() : i ? (e = b().tz(d.timeZone).utcOffset(), f = b(a, j, d.useStrict).utcOffset(), f !== e ? (g = b().tz(d.timeZone).format("Z"), h = b(a, j, d.useStrict).format("YYYY-MM-DD[T]HH:mm:ss") + g, c = b(h, j, d.useStrict).tz(d.timeZone)) : c = b(a, j, d.useStrict).tz(d.timeZone)) : c = b(a, j, d.useStrict), c
            },
            y = function(a) {
            ...
            F = function() {
                var b = a("<div>").addClass("datetimepicker-widget dropdown-menu"),
            ...
            K = function(a) {
                o && (k = a ? Math.max(p, Math.min(3, k + a)) : 0, o.find(".datepicker > div").hide().filter(".datepicker-" + q[k].clsName).show())
            },
            L = function() {
                var b = a("<tr>"),
            ...
            ca = function(a) {
                return void 0 === d.parseInputDate ? b.isMoment(a) || (a = x(a)) : a = d.parseInputDate(a), a
            },
            da = {
                next: function() {
                    var a = q[k].navFnc;
                ...
                selectHour: function(b) {
                    ...
                    h || (e.hours() >= 12 ? 12 !== c && (c += 12) : 12 === c && (c = 0)), _(e.clone().hours(c)), da.showPicker.call(l)
                },
            ...
            ea = function(b) {
                return a(b.currentTarget).is(".disabled") ? !1 : (da[a(b.currentTarget).data("action")].apply(l, arguments), !1)
            },
            fa = function() {
                var b, c = {
                    year: function(a) {
                ...
                return g.prop("disabled") || !d.ignoreReadonly && g.prop("readonly") || o ? l : (void 0 !== g.val() && 0 !== g.val().trim().length ? _(ca(g.val().trim())) : d.useCurrent && m && (d.inline || g.is("input") && 0 === g.val().trim().length) && (b = x(), "string" == typeof d.useCurrent && (b = c[d.useCurrent](b)), _(b)), o = F(), L(), R(), o.find(".timepicker-hours").hide(), o.find(".timepicker-minutes").hide(), o.find(".timepicker-seconds").hide(), $(), K(), a(window).on("resize", H), o.on("click", "[data-action]", ea), o.on("mousedown", !1), n && n.hasClass("btn") && n.toggleClass("active"), H(), o.show(), d.focusOnShow && !g.is(":focus") && g.focus(), I({
                    type: "dp.show"
                }), l)
            },
            ga = function() {
        ...
        if (l.destroy = function() {
                ...
                "string" == typeof a && (a = "now" === a || "moment" === a ? x() : x(a));
                var b = ca(a);
                if (!b.isValid()) throw new TypeError("defaultDate() Could not parse date parameter: " + a);
                if (!Q(b)) throw new TypeError("defaultDate() date passed is invalid according to component setup validations");
                return d.defaultDate = b, (d.defaultDate && d.inline || "" === g.val().trim() && void 0 === g.attr("placeholder")) && _(d.defaultDate), l
            }, l.locale = function(a) {
                if (0 === arguments.length) return d.locale;
                if (!b.localeData(a)) throw new TypeError("locale() locale " + a + " is not loaded from moment locales!");
                return d.locale = a, e.locale(d.locale), f.locale(d.locale), i && oa(), o && (aa(), fa()), l
        ...
        return e = x(), f = e.clone(), a.extend(!0, d, G()), l.options(d), oa(), ka(), g.prop("disabled") && l.disable(), g.is("input") && 0 !== g.val().trim().length ? _(ca(g.val().trim())) : d.defaultDate && void 0 === g.attr("placeholder") && _(d.defaultDate), d.inline && fa(), l
    };
