        ...
        $http({ method: 'Get', url: url })
            .then(function (result) {
                ...
                if ($scope.FeePeriods.length == 0) {
                    var url = "Schools/School/GetFeePeriod?academicYearID=" + $scope.CRUDModel.ViewModel.Academic.Key + "&studentID=" + 0;
                    $http({ method: 'Get', url: url })
                        .then(function (result) {
        ...
        $http({ method: 'Get', url: url })
            .then(function (result) {
                ...
                if (model.IsFeePeriodDisabled != true) {
                    var url = "Schools/School/GetFeePeriod?academicYearID=0" + "&studentID=" + studentID;
                    $http({ method: 'Get', url: url })
                        .then(function (result) {
                            $scope.LookUps.FeePeriod = result.data;
                        }, function () {
