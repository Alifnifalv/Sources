...
namespace Eduegate.ERP.Admin.Areas.Accounts.Controllers
{
    ...
    public class AccountDocumentTypeController : BaseSearchController
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.AccountDocumentType);
        ...
        public ActionResult Create(long ID = 0)
        {
            ...
            return RedirectToAction("Create", "CRUD", new { area = "Frameworks", screen = Screens.AccountDocumentType });
        }
