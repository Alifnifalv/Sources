    ...
    public class BankReconcilationController : BaseController
    {
        ...
        private BankReconcilationViewModel FillBankReconcilationData(long bankReconciliationHeadIID)
        {
            ...
            var manualEntry = (from s in entry.BankReconciliationDetailDtos
                               where s.BankReconciliationMatchedStatusID == (short?)Eduegate.Services.Contracts.Enums.BankReconciliationMatchedStatuses.Matched && s.ReconciliationDate != null
            ...
            bankReconcilationViewModel.BankReconciliationBankTrans = FillBankStatementData(entry.BankStatementEntryDTOs);
            bankReconcilationViewModel.BankReconciliationManualEntry = manualEntry;
