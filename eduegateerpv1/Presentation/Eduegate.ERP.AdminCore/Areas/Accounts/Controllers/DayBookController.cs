...
namespace Eduegate.ERP.Admin.Areas.Accounts.Controllers
{
    ...
    public class DayBookController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.Daybook);
