...
using ImageType = Eduegate.Framework.Helper.Enums.ImageType;
    ...
    public class ProductController : BaseSearchController
    {
        ...
        public JsonResult GetProducts(ProductViewSearchInfoViewModel searchInfo = null)
        {
            try
            {
                ...
                return Json(productViewDetails);
        ...
        public ActionResult Product(long productIID = 0)
        {
            ...
            if (productIID > 0)
            {
                ...
                try
                {
                    ...
                    var tempFolder = string.Format("{0}\\{1}\\{2}\\{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, productIID, ImageType.LargeImage.ToString());
                    if (Directory.Exists(tempFolder))
                    {
                        ...
                        if (imageNames != null && imageNames.Count() > 0)
                        {
                            foreach (var image in imageNames)
                            {
                                ...
                                file.FileName = image;
                                file.FilePath = string.Format("{0}/{1}/{2}/{3}/{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImageHostUrl").ToString(), EduegateImageTypes.Products, productIID, ImageType.LargeImage.ToString(), image);
                    ...
                    var tempVideoFolder = string.Format("{0}\\{1}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos, productIID);
                    ...
                    if (Directory.Exists(tempVideoFolder))
                    {
                        ...
                        if (videoNames != null && videoNames.Count() > 0)
                        {
                            foreach (var video in videoNames)
                            {
                                var file = new UploadedFileDetailsViewModel();
                                file.FileName = video;
                                file.FilePath = string.Format("{0}/{1}/{2}/{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImageHostUrl").ToString(), EduegateImageTypes.ProductVideos, productIID, video);
            ...
            addProduct.DefaultLanguage = new Domain.Setting.SettingBL().GetSettingValue<string>("DefaultLang").ToString();
        ...
        public JsonResult UpdateProduct(AddProductViewModel productDetails)
        {
            ...
            string DesignationFolderPath = string.Format("{0}\\{1}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products);

            //Video
            string tempVideoFolderPath = string.Format("{0}\\{1}\\{2}\\{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos, userID, Constants.TEMPFOLDER);
            string destonationVideoFolderPath = string.Format("{0}\\{1}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos);
        ...
        public JsonResult GetCultureList()
        {
            ...
            {
                string productServiceUrl = ServiceHost + Constants.PRODUCT_DETAIL_SERVICE_NAME;
                return Json(CultureDataInfoViewModel.FromDTO(ClientFactory.ProductDetailServiceClient(CallContext).GetCultureList()));
            }
            catch (Exception ex)
            {
                LogHelper<ProductController>.Fatal(ex.Message.ToString(), ex);
        ...
        public JsonResult GetBrandList(string searchText)
        {
            ...
            try
            {
                var brandList = ClientFactory.ProductDetailServiceClient(CallContext).SearchBrand(searchText, Convert.ToInt32(new Domain.Setting.SettingBL().GetSettingValue<string>("Select2DataSize")));
            ...
            return Json(brandKeyValueViewModel);
        }
        ...
        public JsonResult GetProductFamilies(string searchText)
        {
            ...
            try
            {
                var familyList = ClientFactory.ProductDetailServiceClient(CallContext).SearchProductFamilies(searchText, Convert.ToInt32(new Domain.Setting.SettingBL().GetSettingValue<string>("Select2DataSize")));
            ...
            return Json(familyKeyValueViewModel);
        }
        ...
        public JsonResult GetProductStatus()
        {
            try
            {
                return Json(ProductStatusViewModel.ToViewModel(ClientFactory.ProductDetailServiceClient(CallContext).GetProductStatus()));
        ...
        public JsonResult GetProductTypes()
        {
            ...
            return Json(productTypesViewModelList);
        }
        ...
        public ActionResult GetProductPropertyTypes(decimal productFamilyIID)
        {
            ...
            return Json(propertyTypeViewModelList);
        }
        ...
        public JsonResult GetPropertiesByPropertyTypeID(decimal propertyTypeIID)
        {
            ...
            return Json(propertyViewModelList);
        }

        public async Task<IActionResult> List()
        {
            // call the service and get the meta data
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList(Services.Contracts.Enums.SearchView.Product);
        ...
        {
            // call the service and get the meta data
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList(Services.Contracts.Enums.SearchView.ProductSKU);
        ...
        [HttpGet]
        public Task<IActionResult> SearchData(int currentPage = 1, string orderBy = "", string runtimeFilter = "", string runtimeFilter2 = "")
        {
        ...
        [HttpPost]
        public async Task<ActionResult> UploadProductImages(long existingFileNameIndex = 0)
        {
            ...
            try
            {
                ...
                string tempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}", imagePhysicalPath, EduegateImageTypes.Products, Constants.TEMPFOLDER, userID);
                ...
                foreach (var file in Request.Form.Files)
                {
                    ...
                    if (file != null && file.Length > 0)
                    {
                        ...
                        imageInfo.FilePath = Path.Combine(imageHostUrl, EduegateImageTypes.Products.ToString(), Constants.TEMPFOLDER, userID.Value.ToString(), imageFileName);
        ...
        public ActionResult DeleteUploadProductImages(string fileName, long productID = 0)
        {
            ...
            try
            {
                ...
                {
                    string tempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, Constants.TEMPFOLDER, userID, fileName);
                    ...
                    if (productID != 0)
                    {
                        string productPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, productID, ImageType.LargeImage.ToString(), fileName);
                        ...
                        productPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, productID, ImageType.ListingImage.ToString(), fileName);
                        ...
                        productPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, productID, ImageType.SmallImage.ToString(), fileName);
                        ...
                        productPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, productID, ImageType.ThumbnailImage.ToString(), fileName);
                ...
                {
                    var file = string.Format("{0}\\{1}\\{2}\\{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, Constants.TEMPFOLDER, userID);
        ...
        public bool ResizeProductImage(long userID, ImageType imageType)
        {
            ...
            {
                string tempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, Constants.TEMPFOLDER, userID);
                string DesignationTempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.Products, Constants.TEMPFOLDER, userID, imageType.ToString());
        ...
        public JsonResult GetProductListBySearch(string searchText = "", long excludeProductFamilyID = default(long))
        {
            ...
            return Json(new { IsError = hasError, ProductList = productList });
        }
        ...
        public JsonResult GetProductMaps(long productID)
        {
            ...
            return Json(new { IsError = hasError, ProductMap = productMapViewModel });
        }
        ...
        public JsonResult GetProductToProductMap(long productID)
        {
            ...
            return Json(new { IsError = hasError, ProductMap = productToProductMapViewModel });
        }
        ...
        public JsonResult GetProductTags()
        {
            ...
            return Json(new { IsError = false, ProductTags = vmTags });
        }
        ...
        public JsonResult GetSKUTags()
        {
            try
            {
                return Json(new { IsError = false, SKUTags = KeyValueViewModel.FromDTO(ClientFactory.ProductDetailServiceClient(CallContext).GetProdctSKUTags()) });
            }
            catch (Exception ex)
            {
                LogHelper<ProductController>.Info("Exception : " + ex.Message.ToString());
        ...
        public JsonResult CreateProperties(List<ProductTagViewModel> productTags)
        {
            ...
            return Json(new { IsError = false, ProductTags = dbProductTags });
        }
        ...
        //TODO: Temporary code commented and added new code for video upload
        //[HttpPost]
        ...
        //    {
        //        var userID = base.CallContext.LoginID;
        //        string tempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos, userID, Constants.TEMPFOLDER);
        ...
        //                videoInfo.FilePath = Path.Combine(new Domain.Setting.SettingBL().GetSettingValue<string>("ImageHostUrl").ToString(),
        ...
        //    return Json(new { Success = isSavedSuccessfully, FileInfo = videoInfoList });
        //}
        ...
        public ActionResult UploadProductVideos(long existingFileNameIndex = 0)
        {
            ...
            {
                var userID = base.CallContext.LoginID; // Needs to fetch from call context
                string tempFolderPath = Path.Combine(new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos.ToString(), userID.ToString(), Constants.TEMPFOLDER);
                var fileNameIndex = existingFileNameIndex > 0 ? existingFileNameIndex + 1 : GetLastUploadedVideoName(tempFolderPath);
                ...
                foreach (var formFile in Request.Form.Files)
                {
                    ...
                    {
                        var videoInfo = new UploadedFileDetailsViewModel();
                        var videoExtension = Path.GetExtension(formFile.FileName).ToLower();
                        var videoFileName = fileNameIndex + videoExtension;
                        ...
                        using (var fileStream = new FileStream(Path.Combine(tempFolderPath, videoFileName), FileMode.Create))
                        {
        ...
        public ActionResult DeleteUploadProductVideos(string fileName)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    string tempFolderPath = string.Format("{0}\\{1}\\{2}\\{3}\\{4}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos, userID, Constants.TEMPFOLDER, fileName);
                ...
                {
                    var file = string.Format("{0}\\{1}\\{2}", new Domain.Setting.SettingBL().GetSettingValue<string>("ImagesPhysicalPath").ToString(), EduegateImageTypes.ProductVideos, userID);
                    if (System.IO.Directory.Exists(file))
                        System.IO.Directory.Delete(file, true);
                }
            }
        ...
        public JsonResult GetProducts(string searchText)
        {
            ...
            List<POSProductDTO> posProductItems = ClientFactory.ProductCatalogServiceClient(CallContext, null).GetProductListWithSKU(searchText, dataSize);
            ...
            return Json(vmKeyValues);
        }

        [HttpGet]
        public JsonResult GetProductAndSKUByID(long productSKUMapID)
        {
            return Json(ExternalProductSettingsViewModel.POSProductDTOtoExternalProductSettingsViewModel(ClientFactory.ProductCatalogServiceClient(CallContext, null).GetProductAndSKUByID(productSKUMapID)));
        }
