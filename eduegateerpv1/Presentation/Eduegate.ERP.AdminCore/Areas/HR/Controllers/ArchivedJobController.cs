...
namespace Eduegate.ERP.Admin.Areas.HR.Controllers
{
    ...
    public class ArchivedJobController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.ArchivedJobs);
