...
namespace Eduegate.ERP.Admin.Areas.HR.Controllers
{
    ...
    public class JobOpeningController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.JobOpening);
            ...
            {
                ViewName = Eduegate.Infrastructure.Enums.SearchView.JobOpening,
                ControllerName = "HR/JobOpening",
...
//                        </li>",
        ...
        public Task<IActionResult> SearchData(int currentPage = 1, string orderBy = "", string runtimeFilter = "")
        {
            ...
            return base.SearchData(Eduegate.Infrastructure.Enums.SearchView.JobOpening, currentPage, orderBy, filter);
        }
        ...
        public ActionResult Create(string ID = "")
        {
            ...
            //viewModel.Name = "JobOpening";
            //viewModel.ListActionName = "HR/JobOpening";
            //viewModel.ListButtonDisplayName = "Job Opening List";
            //viewModel.DisplayName = "Create/Edit Job Opening";
            var viewModel = new JobOpeningViewModel() { CreatedDate = DateTime.Now.ToString() };
            //viewModel.IID = 0;
            //viewModel.IID2 = ID;
        ...
        public ActionResult Get(string ID = null)
        {
            ...
            return Json(new JobOpeningViewModel().ToVM(dto, cultureData));
        }

      
        [HttpPost]
        public JsonResult Save([FromBody] JobOpeningViewModel vm)
        {
            var cultureData = ClientFactory.ReferenceDataServiceClient(CallContext).GetCultureList();
