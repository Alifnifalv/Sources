...
namespace Eduegate.ERP.Admin.Areas.Inventories.Controllers
{
    ...
    public class InventoryDetailsController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Infrastructure.Enums.SearchView.InventoryDetails);
        ...
        public async Task<IActionResult> ChildList(long ID)
        {
            ...
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList(Services.Contracts.Enums.SearchView.InventoryBranch);
        ...
        public ActionResult Edit(long ID)
        {
            ...
            var skuDetails = ClientFactory.ProductCatalogServiceClient(CallContext, null).GetProductAndSKUByID(ID);
        ...
        public JsonResult GetTaxDetails(int documentID)
        {
            try
            {
                ...
                return Json(TaxDetailsViewModel.ToVM(result, null));
            }
            catch (Exception ex)
            {
                Eduegate.Logger.LogHelper<PurchaseOrderController>.Fatal(ex.Message.ToString(), ex);
        ...
        public JsonResult GetProductSKUInventoryDetail(long skuIID, int? documentReferenceTypeID, long branchID)
        {
            try
            {
                ...
                var result = ClientFactory.ProductCatalogServiceClient(CallContext, null).GetProductSKUInventoryDetail(skuIID, (DocumentReferenceTypes)documentReferenceTypeID, branchID);
                return Json(result);
            }
            catch (Exception ex)
            {
