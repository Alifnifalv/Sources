...
namespace Eduegate.ERP.Admin.Areas.Securities.Controllers
{
    ...
    public class ClaimController : BaseSearchController
    {
        ...
        {
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.Claim);
        ...
        public ActionResult Create(long ID = 0)
        {
            ...
            viewModel.Name = "Securities/Claim";
            viewModel.ListActionName = "Securities/Claim";
        ...
        [HttpPost]
        public JsonResult Save([FromBody] ClaimViewModel vm)
        {
