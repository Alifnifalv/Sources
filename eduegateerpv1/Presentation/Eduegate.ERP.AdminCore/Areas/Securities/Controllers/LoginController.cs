...
namespace Eduegate.ERP.Admin.Areas.Securities.Controllers
{
    ...
    public class LoginController : BaseSearchController
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var metadata = await ClientFactory.SearchServiceClient(CallContext).SearchList((Services.Contracts.Enums.SearchView)(int)Eduegate.Infrastructure.Enums.SearchView.Login);
