...
{
    //TODO: Report aspx code didn't support in core, commented to remove error
    ...
    //    public string RootUrl = new Domain.Setting.SettingBL().GetSettingValue<string>("RootUrl");
    ...
    //        string siteCookieKey = new Domain.Setting.SettingBL().GetSettingValue<string>("SiteCookieKey");
    //        string callContextKey = new Domain.Setting.SettingBL().GetSettingValue<string>("ContextKey");
    ...
    //                var logDTO = ClientFactory.CertificateServiceClient(null).GetCertificateLogByID(masterId);
    //                var certificateTemplate = ClientFactory.CertificateServiceClient(null).GetCertificateTemplateByID((long)logDTO.CertificateTemplateIID);
    ...
    //            var schoolID_Thumama = ClientFactory.SettingServiceClient(null).GetSettingDetail("SCHOOLID_THUMAMA_10");
    //            var schoolID_WestBay = ClientFactory.SettingServiceClient(null).GetSettingDetail("SCHOOLID_WESTBAY_20");
    //            var schoolID_Meshaf = ClientFactory.SettingServiceClient(null).GetSettingDetail("SCHOOLID_MESHAF_30");
    ...
    //                {
    //                    var footer = ClientFactory.SettingServiceClient(null).GetSettingDetail("REPORT_FOOTER_SCHOOL_ADDRESS_THUMAMA_10");
    //                    if (footer != null)
    //                    {
    ...
    //                {
    //                    var footer = ClientFactory.SettingServiceClient(null).GetSettingDetail("REPORT_FOOTER_SCHOOL_ADDRESS_WESTBAY_20");
    //                    if (footer != null)
    //                    {
    //                        if (viewer.LocalReport.GetParameters().Where(a => a.Name == "ReportFooter").FirstOrDefault() != null)
    //                        {
    ...
    //                else
    //                {
    //                    var footer = ClientFactory.SettingServiceClient(null).GetSettingDetail("REPORT_FOOTER_SCHOOL_ADDRESS_MESHAF_30");
    //                    if (footer != null)
    //                    {
    //                        if (viewer.LocalReport.GetParameters().Where(a => a.Name == "ReportFooter").FirstOrDefault() != null)
    //                        {
    ...
    //                {
    //                    var logo = ClientFactory.SettingServiceClient(null).GetSettingDetail("COMPANY_REPORT_LOGO_PODAR");
    //                    if (logo != null)
    //                    {
    ...
    //                else
    //                {
    //                    var logo = ClientFactory.SettingServiceClient(null).GetSettingDetail("COMPANY_REPORT_LOGO_PEARL");
    //                    if (logo != null)
    //                    {
    //                        if (viewer.LocalReport.GetParameters().Where(a => a.Name == "Logo").FirstOrDefault() != null)
    //                        {
    ...
    //                var schoolSeal = ClientFactory.SettingServiceClient(null).GetSettingDetail("SCHOOL_STAMP");
    //                if (schoolSeal != null)
    //                {
    ...
    //                if (_CallContext.SchoolID == short.Parse(schoolID_Meshaf.SettingValue))
    //                {
    //                    var signature = Eduegate.Services.Client.Factory.ClientFactory.SettingServiceClient(null).GetSettingDetail("PRINCIPAL_SIGNATURE_01");
    //                    if (signature != null)
    //                    {
    ...
    //           new SqlDataAdapter(dataset.Query.CommandText, Framework.Extensions.ConfigurationExtensions.GetConnectionString("dbEduegateERPContext")))
    //        {
    ...
    //        string filename = string.Format("{0}\\{1}\\{2}\\{3}.pdf",new Domain.Setting.SettingBL().GetSettingValue<string>("DocumentsPhysicalPath").ToString(), "Reports", "Temp", reportTitled);
    ...
    //        {
    //            //var filepath = Path.Combine(new Domain.Setting.SettingBL().GetSettingValue<string>("DocumentsVirtualPath").ToString(), "Reports", "Temp", Path.GetFileName(filename));
    ...
    //        return Path.Combine(new Domain.Setting.SettingBL().GetSettingValue<string>("DocumentsVirtualPath").ToString(), "Reports", "Temp", Path.GetFileName(filename));
    //    }
    ...
    //            var hostDet = ClientFactory.SettingServiceClient(null).GetSettingDetail("HOST_NAME").SettingValue;

    //            string defaultMail = ClientFactory.SettingServiceClient(null).GetSettingDetail("DEFAULT_MAIL_ID").SettingValue;

    //            String replaymessage = new Eduegate.Domain.Notification.EmailNotificationBL(_context).PopulateBody(emailID, emailBody);
    ...
    //        {
    //            get { return new System.Net.NetworkCredential(new Domain.Setting.SettingBL().GetSettingValue<string>("ReportServerDomainUser"), new Domain.Setting.SettingBL().GetSettingValue<string>("ReportServerDomainPassword")); }
    //        }
    //    }
    ...
    //    {
    //        var headerBGColor = ClientFactory.SettingServiceClient(null).GetSettingDetail("REPORT_HEADER_BGCOLOR");
    //        if (headerBGColor != null)
    //        {
    ...
    //        viewer.LocalReport.Refresh();
    //        var certificateTemplate = ClientFactory.CertificateServiceClient(null).GetCertificateTemplate(reportName);
    ...
    //            };
    //            certificateTemplate = ClientFactory.CertificateServiceClient(null).SaveCertificateTemplate(certificate);
    //        }
    ...
    //        };
    //        var certificate_log = ClientFactory.CertificateServiceClient(null).SaveCertificateLog(certificateLog);
    ...
    //                IssuedDate = DateTime.Parse(parameters[6].Values[0]),
    //                CBSC = parameters[4].Values[0].ToString(),
    //                PassedorFailedString = parameters[5].Values[0].ToString(),
    //                StudentTransferRequestIID = int.Parse(parameters[7].Values[0]),
    //            };
    ...
    //        {
    //            using (SqlConnection _sConn = new SqlConnection(Framework.Extensions.ConfigurationExtensions.GetConnectionString("dbEduegateERPContext")))
    //            {
    //                try { _sConn.Open(); }
    //                catch { return _sDt; }
