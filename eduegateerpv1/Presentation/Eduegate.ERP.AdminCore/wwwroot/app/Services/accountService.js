    ...
    function accountService($http) {
        ...
        */
        function getBillingShippingContact(customerID, addressType) {
            url = 'Inventories/SalesOrder/GetDeliveryAddress?customerID=' + customerID + '&addressType=' + addressType;
            return $http.get(url)
        ...
        function getContactByCustomerId(customerId) {
            url = 'Inventories/Customer/GetContactByCustomerId?customerId=' + customerId;
            return $http.get(url)
