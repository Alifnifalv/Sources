app.controller("OnlineExamResultController", ["$scope", "$http", "$compile", "$window", "$timeout", "$location", "$route", "$rootScope", function ($scope, $http, $compile, $window, $timeout, $location, $route, $root) {
    ...
    $scope.ResetMarkEntry = function () {

        showOverlay();

        if ($scope.SelectedCandidate) {
            $scope.SelectedCandidate.Key = null;
            $scope.SelectedCandidate.Value = null;
            $scope.SelectedCandidate = null;
        }

        if ($scope.SelectedAcademicYear) {
            $scope.SelectedAcademicYear.Key = null;
            $scope.SelectedAcademicYear.Value = null;
            $scope.SelectedAcademicYear = null;
        }

        if ($scope.SelectedExam) {
            $scope.SelectedExam.Key = null;
            $scope.SelectedExam.Value = null;
            $scope.SelectedExam = null;
        }
