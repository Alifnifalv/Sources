    ...
    public class FormBuilderController : BaseController
    {
        ...
        public ActionResult CoachingFormSubmit()
        {
            try
            {
                ...
                var formID = int.Parse(formDatas["FormID"]);
                ...
                foreach (var form in formDatas)
                {
                    ...
                    {
                        FormID = formID,
                        FormFieldName = form.ToString(),
                        FormFieldValue = formDatas[form.ToString()],
                        ReferenceID = formDatas["StudentID"] != null ? long.Parse(formDatas["StudentID"]) : (long?)null,
                    });
                }
        ...
        public JsonResult GetCoachingFormList()
        {
            ...
            {
                return Json(new { IsError = false, Response = coachingFormDTOs }, JsonRequestBehavior.AllowGet);
            }
        }
