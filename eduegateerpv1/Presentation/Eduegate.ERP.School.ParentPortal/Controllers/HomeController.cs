...
namespace Eduegate.ERP.School.ParentPortal.Controllers
{
    public class HomeController : BaseController
    {
        ...
        {
            var cultureCode = this.Request.QueryString["language"];
            ...
            if (ClientFactory.AccountServiceClient(CallContext).IsPasswordResetRequired(CallContext.EmailID))
                return RedirectPermanent("~/Account/ResetPassword");
        ...
        public ActionResult ApplicationF(long Id = 0)
        {
            ...
            return View("ApplicationF", "_Layout", vm);
        }
        ...
        public ActionResult GetStudentTransportDetails(Int64? StudentID)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("[schools].[GET_STUDENT_TRANSPORT_DETAILS_BY_PARENT_LOGINID]", conn))
            {
                ...
                if (dataTable != null)
                {
                    foreach (DataRow row in dataTable.Rows)
                    {
                        ...
                        DateTime DateFrom = Convert.ToDateTime(stringDateFrom); //string.IsNullOrEmpty(row.ItemArray[6].ToString()) ? (DateTime?)null : DateTime.ParseExact(row.ItemArray[6].ToString(), dateFormat, CultureInfo.InvariantCulture);
                        DateTime DateTo = Convert.ToDateTime(stringDateTo); //string.IsNullOrEmpty(row.ItemArray[7].ToString()) ? (DateTime?)null : DateTime.ParseExact(row.ItemArray[7].ToString(), dateFormat, CultureInfo.InvariantCulture);
                        ...
                        studentTransport.DateTo = DateFrom.ToString("dd-MM-yyyy");
            ...
            return Json(studentsTrasnports, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetStudentProgressReport(Int64? StudentID)
        {
            ...
            using (IDbConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbEduegateERPContext"].ConnectionString))
            {
                ...
                try
                {
                    var reader = conn.QueryMultiple("[schools].[GET_STUDENT_PROGRESS_REPORT]",
                                   param: new { StudentID = StudentID },
                                 commandType: CommandType.StoredProcedure);
                    var markList = reader.Read<STUDENT_PROGRESS_REPORT_MARKLIST>().ToList();
                    var examList = reader.Read<STUDENT_PROGRESS_REPORT>().ToList();
                    var progressReportList = new List<STUDENT_PROGRESS_REPORT>().ToList();
                    if (markList.Count() > 0)
                    {
                        ResModel.Data = new
                        {
            ...
            using (IDbConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbEduegateERPContext"].ConnectionString))
            {
                ...
                try
                {
                    var reader = conn.QueryMultiple("[schools].[GET_MAIL_LIST]",
                                   param: new { LoginID = CallContext.LoginID, FloderName = Folder },
                                 commandType: CommandType.StoredProcedure);
        ...
        public JsonResult GetNotificationAlertsCount()
        {
            ...
            return Json(alertCount, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult GetUserDetails()
        {
            ...
            else
            {
                ...
                {
                    userDetail.ProfileFile = string.Format("{0}/{1}/{2}", ConfigurationExtensions.GetAppConfigValue("ImageHostUrl"), EduegateImageTypes.UserProfile, userDetail.ProfileFile);
                }
        ...
        public ActionResult NewApplication(long loginID)
        {
            ...
            return View("NewApplication", "_Layout_Guest", vm);
        }

        public ActionResult GetApplication(long Id)
        {
            var application = ClientFactory.SchoolServiceClient(CallContext).GetApplication(Id);
            return Json(new { IsError = false, Response = application }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult SubmitApplication(StudentApplicationViewModel application)
        {
            ...
            try
            {
                ...
                if (crudSave.IsError)
                {
                    ...
                    return View("NewApplication", "_Layout_Guest", application);
                }
                else
                {
                    return RedirectPermanent("~/Home/AnonymousDashbaord");
        ...
        public ActionResult NewSiblingApplication(long Id = 0)
        {
            ...
            return View("NewApplicationFromParent", "_Layout", vm);
        }
        ...
        public ActionResult DeleteSiblingApplication(long Id)
        {
            ...
            return RedirectPermanent("~/Home/ApplicationListFromParent");
        }
        ...
        [HttpPost]
        public ActionResult SubmitSiblingApplication(StudentApplicationViewModel application)
        {
            ...
            try
            {
                ...
                if (crudSave.IsError)
                {
                    ...
                    return View("NewApplicationFromParent", "_Layout", application);
                }
                else
                {
                    var emailUser = ConfigurationExtensions.GetAppConfigValue("EmailUser").ToString();
                    ...
                    String replaymessage = PopulateBody("Parent", emailBody);
                    ...
                    if (hostDet == "Live")
                    {
                        SendMail(application.ParentLoginEmailID, "Automatic reply: Received your application", replaymessage, emailUser, fromEmail);
                    }
                    else
                    {
                        SendMail(defaultMail, "Automatic reply: Received your application", replaymessage, emailUser, fromEmail);
                    }
        ...
        public JsonResult SendMail(string email, string subject, string msg, string mailname, string frommailaddress)
        {
            ...
            try
            {
                ...
                mailMsg.From = new MailAddress(frommailaddress, mailname);
        ...
        public ActionResult StudentLeaveApplication(long Id = 0)
        {
            ...
            return View("StudentLeaveApplication", "_Layout", vm);
        }
        ...
        public ActionResult GetLeaveApplication(long Id)
        {
            ...
            var leaveApplication = ClientFactory.SchoolServiceClient(CallContext).GetLeaveApplication(Id);
            return Json(new { IsError = false, Response = leaveApplication }, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult SubmitLeaveApplication(StudentLeaveApplicationViewModel leaveApplication)
        {
            try
            {
                if (CallContext.LoginID == null)
        ...
        public JsonResult ComposeMail(CallContext context, ComposeMailClass mailClass)
        {
            try
            {
                ...
                if (hostDet == "Live")
                {
                    SendMail(mailClass.tomail, mailClass.subjectmail, replaymessage, MailName[0], mailClass.frommail);
                }
                else
                {
                    SendMail(defaultMail, mailClass.subjectmail, replaymessage, MailName[0], mailClass.frommail);
                }

                var notifications = new List<NotificationAlertsDTO>();
                try
                {
                    using (SqlConnection conn = new SqlConnection(ConfigurationExtensions.GetConnectionString("dbEduegateSchoolContext").ToString()))
                    {
        ...
        public JsonResult GetStudentsSiblings(long parentId)
        {
            ...
            {
                return Json(new { IsError = true, Response = "There are some issue !" }, JsonRequestBehavior.AllowGet);
            }
            else
            {
                return Json(new { IsError = false, Response = siblingsDetail }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetCircularList()
        {
            ...
            {
                return Json(new { IsError = false, Response = circularDetail }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetGalleryView(long academicYearID)
        {
            ...
            {
                return Json(new { IsError = false, Response = galleryView }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetLessonPlanList(long studentID)
        {
            ...
            {
                return Json(new { IsError = false, Response = lessonPlanDetail }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetAgendaList(long studentID)
        {
            ...
            {
                return Json(new { IsError = false, Response = agendaList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult FillFeeDue(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = feeTypes }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetMarkListStudentwise(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = markLists }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetAssignmentStudentwise(long studentId , int? SubjectID)
        {
            ...
            foreach (var assignment in data)
            {
                var ass = new AssignmentViewViewModel()
                {
                    ...
                    Class = assignment.ClassID.HasValue ? new KeyValueViewModel() { Key = assignment.ClassID.ToString(), Value = assignment.Class.Value } : new KeyValueViewModel(),
            ...
            {
                return Json(new { IsError = false, Response = AssignmentList }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult Getstudentsubjectlist(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = data }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetStudentDetails(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = StudentDetail }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetStudentLeaveApplication(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = StudentLeaveApplication }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetClassTimeTable(long studentId)
        {
            ...
            foreach (var tta in data)
            {
                var ta = new TimeTableAllocationViewModel()
                {
                    ...
                    Class = tta.ClassId.HasValue ? new KeyValueViewModel() { Key = tta.ClassId.ToString(), Value = tta.Class.Value } : new KeyValueViewModel(),
            ...
            {
                return Json(new { IsError = false, Response = ClassTimeTable }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetExamLists(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = ExamLists }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public ActionResult StudentTransferApplication(long Id = 0)
        {
            ...
            return View("StudentTCApplication", "_Layout", vm);
        }
        ...
        public ActionResult GetTransferApplication(long Id)
        {
            ...
            return Json(new { IsError = false, Response = TransferApplication }, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult SubmitTransferApplication(StudentTransferRequestViewModel TransferApplication)
        {
        ...
        public JsonResult GetStudentTransferApplication(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = StudentTransferRequestApplication }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetApplicationByLoginID(long loginID)
        {
            ...
            {
                return Json(new { IsError = false, Response = ApplicationList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetTeacherDetails(long studentId)
        {
            ...
            {
                return Json(new { IsError = false, Response = TeacherDetail }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetStudentSkillRegister(long studentId, int ClassID)
        {
            ...
            {
                return Json(new { IsError = false, Response = dataList }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetNotificationAlerts()
        {
            ...
            {
                return Json(new { IsError = false, Response = notificationAlerts }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetCastByRelegion(int relegionID)
        {
            ...
            if (castList == null)
            {
                return Json(new { IsError = true, Response = "There are some issue, please check with the administrator." }, JsonRequestBehavior.AllowGet);
            }
            else
            {
                return Json(new { IsError = false, Response = castList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetStreamByStreamGroup(byte? streamGroupID)
        {
            ...
            {
                return Json(new { IsError = false, Response = streamList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetClasseByAcademicyear(int academicyearID)
        {
            ...
            {
                return Json(new { IsError = false, Response = classList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetAcademicYearBySchool(int schoolID)
        {
            ...
            {
                return Json(new { IsError = false, Response = yearList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetAboutandContactDetails(long contentID)
        {
            ...
            {
                return Json(new { IsError = false, Response = aboutandContactDetail }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetTeacherEmailByParentLoginID()
        {
            ...
            using (IDbConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbEduegateERPContext"].ConnectionString))
            {
                ...
                try
                {
                    var reader = conn.QueryMultiple("[schools].[GET_ALL_TEACHERS_MAIL_ID_BY_PARENT_LOGINID]",
                                   param: new { LoginID = CallContext.LoginID },
                                 commandType: CommandType.StoredProcedure);
                    var mailList = reader.Read<TEACHERS_MAIL_ID_BY_PARENT_LOGINID>().ToList();
                    if (mailList.Count() > 0)
                    {
                        ResModel.Data = new
                        {
        ...
        public JsonResult GetUserTransportApplications()
        {
            ...
            {
                return Json(new { IsError = false, Response = listDatas }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public TransportApplicationViewModel GetStudentDetailsForTransportApplication(long id)
        {
            ...
            //else
            //{
            //    return Json(new { IsError = false, Response = applicationDetails }, JsonRequestBehavior.AllowGet);
            //}
        ...
        public ActionResult SubmitTransportApplication(TransportApplicationViewModel transportApplication)
        {
            var dateFormat = ConfigurationExtensions.GetAppConfigValue("DateFormat");
            ...
            {
                return RedirectPermanent("~/Home/StudentTransportRequestList");
            }
            //return Json(new { IsError = false, Response = crudSave }, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult GetSchoolsByParentLoginID(long? loginID)
        {
            ...
            return Json(schoolLists, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult GetAgeCriteriaDetails(int? classID, int? academicID, byte? schoolID, string dobString)
        {
            ...
            return Json(ageCriteriaWaringMessage, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult GetAllAcademicYearBySchoolID(int schoolID)
        {
            ...
            {
                return Json(new { IsError = false, Response = academicYearList }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public JsonResult GetStudentPickupRequests()
        {
            try
            {
                ...
                {
                    return Json(new { IsError = false, Response = pickupRequests }, JsonRequestBehavior.AllowGet);
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SubmitStudentPickupRequest(StudentPickupRequestViewModel studentPickupRequest)
        {
            try
            {
                var dateFormat = ConfigurationExtensions.GetAppConfigValue("DateFormat");
        ...
        public JsonResult GetReportCardList(long studentID, int classID, int sectionID, int academicYearID)
        {
            ...
            {
                return Json(new { IsError = false, Response = reportCards }, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public ActionResult TransportApplicationClick(long id)
        {
            ...
            return View("StudentTransportRequestApplication", "_Layout", vm);
        }
        ...
        public JsonResult GetStudentProgressReports(ProgressReportDTO toDto)
        {
            ...
            {
                return Json(new { IsError = false, Response = progressReportsData }, JsonRequestBehavior.AllowGet);
            }
        }
