<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewer.aspx.cs" Inherits="Eduegate.ERP.School.Portal.Reports.ReportViewer" %>
...
<script src="<%=ResolveUrl("~/scripts/print.min.js") %>" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
        <div  class="panel panel-default" style="visibility:hidden; margin:5px 5px 5px 5px">
            ...
            <div id="collapse1" class="panel-collapse in" style="visibility: collapse;">
      ...
      <asp:button style="width: 80px;height: 35px;margin-left: 7px;font-weight: bolder;" 
          runat="server" ID="btnView" text="View" OnClick="btnView_Click"/>
                        ...
                        <asp:button visible="false" style="width: 80px;height: 35px;margin-left: 7px;font-weight: bolder;" 
          runat="server" ID="btnPrint" text="Print" OnClick="btnPrint_Click"/>

                <asp:button style="width: 80px;height: 35px;margin-left: 7px;font-weight: bolder;" 
          runat="server" ID="btnDownload" text="Download" OnClick="btnDownload_Click"/>
                        ...
                        <asp:ScriptManager ID="ScriptManager1" runat="server">
                          ...
                          <rsweb:ReportViewer ID="viewer" runat="server" ProcessingMode="Local" SizeToReportContent="true"
                              AsyncRendering="true" PageCountMode="Actual" ShowPageNavigationControls="true" KeepSessionAlive="true"
