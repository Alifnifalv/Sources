app.controller('SiblingApplicationController', ['$scope', '$http', '$compile', "$rootScope", "subscriptionService",
    "toaster", '$timeout', '$location', "$q", function ($scope, $http, $compile, $rootScope, $subscription, $toaster,
        ...
        //    $scope.StreamDatas = [];
        //    $scope.StreamSubjects = [];
        //    $scope.StreamOPtionalSubjects = [];
        //    $('.preload-overlay').show();
        //    var getID = document.getElementById("StreamGroup");
        //    var streamGroupID = getID.value;
        //    $scope.StreamGroupKey = streamGroupID;
        //    $.ajax({
        //        type: "GET",
        ...
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
        //                    $scope.onStreamsGroup = true;
        //                    $scope.onStreams_1 = false;
        //                    $scope.StreamDatas = result.Response;
        //                    $timeout(function () {
        //                        $('#StreamKey').val($scope.StudentApplication.StreamID);
        //                    }, 10);
        ...
        //        url: utility.myHost + "/Home/GetStreamCompulsorySubjects?streamID",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (result) {
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
        ...
        //        type: "GET",
        //        data: { streamID: streamID },
        //        url: utility.myHost + "/Home/GetStreamOptionalSubjects?streamID",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (result) {
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
