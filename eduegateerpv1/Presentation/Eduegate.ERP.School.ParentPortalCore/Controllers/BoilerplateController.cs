...
namespace Eduegate.ERP.School.ParentPortal.Controllers
{
    public class BoilerplateController : BaseController
    {
        ...
        public JsonResult Template(BoilerPlateInfoViewModel boilerPlateInfo)
        {
            ...
            return Json(new { BoilerplateMapIID = boilerPlateInfo.BoilerPlateMapIID });
        }

        [HttpPost]
        public async Task<IActionResult> GetBoilerPlates(BoilerPlateInfoViewModel boilerPlateInfo)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetBoilerPlatesWithDetails(BoilerPlateInfoViewModel boilerPlateInfo)
        {
            var dto = await ClientFactory.BoilerPlateServiceClient(CallContext).GetBoilerPlates(BoilerPlateInfoViewModel.ToDTO(boilerPlateInfo)); ;
