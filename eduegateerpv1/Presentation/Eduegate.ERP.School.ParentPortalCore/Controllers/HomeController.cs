    ...
    public class HomeController : BaseController
    {
        ...
        public JsonResult GetUserDetails()
        {
            ...
            else
            {
                ...
                {
                    userDetail.ProfileFile = string.Format("{0}/{1}/{2}", new SettingBL().GetSettingValue<string>("ImageHostUrl"), EduegateImageTypes.UserProfile, userDetail.ProfileFile);
                }
        ...
        public ActionResult SubmitSiblingApplication(StudentApplicationViewModel application)
        {
            ...
            try
            {
                ...
                {
                    var emailUser = new SettingBL().GetSettingValue<string>("EmailUser").ToString();
                    var fromEmail = new SettingBL().GetSettingValue<string>("EmailFrom").ToString();
        ...
        {
            var hostEmail = new SettingBL().GetSettingValue<string>("SMTPUserName").ToString();
            var hostPassword = new SettingBL().GetSettingValue<string>("SMTPPassword").ToString();
            ...
            try
            {
                ...
                ss.Host = new SettingBL().GetSettingValue<string>("EmailHost").ToString();//"smtpout.secureserver.net";// "smtp.gmail.com";//"smtp.zoho.com";//
                ss.Port = new Domain.SettingBL().GetSettingValue<int>("smtpPort");// 587;//465;//;
                ss.Timeout = 20000;
        ...
        public ActionResult GetLeaveApplication(long Id)
        {
            ...
            var leaveApplication = ClientFactory.SchoolServiceClient(CallContext).GetLeaveApplication(Id);
            return Json(new { IsError = false, Response = leaveApplication });
        }
        ...
        public JsonResult ComposeMail(CallContext context, ComposeMailClass mailClass)
        {
            try
            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(Framework.Extensions.ConfigurationExtensions.GetConnectionString("dbEduegateSchoolContext").ToString()))
                    {
        ...
        public JsonResult GetAssignmentStudentwise(long studentId , int? SubjectID)
        {
            ...
            var dateFormat = new SettingBL().GetSettingValue<string>("DateFormat");
