app.controller('SiblingApplicationController', ['$scope', '$http', '$compile', "$rootScope", "subscriptionService",
    "toaster", '$timeout', '$location', "$q", function ($scope, $http, $compile, $rootScope, $subscription, $toaster,
        $timeout, $location, $q) {
        console.log('SiblingApplicationController controller loaded.');
        $scope.Applications = [];
        $scope.Casts = [];
        $scope.Nationalities = [];
        $scope.Relegions = [];
        ...
        //$scope.OptionalSubject1_ID = null;
        //$scope.OptionalSubject2_ID = null;
        //$scope.Optional = [];
        ...
        $scope.init = function (model) {
            ...
            if (model.ClassID != null || model.ClassID != undefined) {
                if ($scope.ClassKey.Key == undefined || $scope.ClassKey.Key == null) {
                    $scope.ClassKey = model.StudentClass
                }
        ...
        $scope.datetimepickerclick = function () {
            alert("in");
        };
        ...
        function GetStreamListFull() {
            return $q(function (resolve, reject) {
                $.ajax({
                    type: 'GET',
                    url: utility.myHost + "Home/GetFullStreamListDatas",
                    success: function (result) {
                        $timeout(function () {
                            $scope.StreamFullList = result.Response;
                            console.log($scope.StreamFullList);
                        });
        ...
        function GetStreams() {
            return $q(function (resolve, reject) {
                $.ajax({
                    type: 'GET',
                    url: utility.myHost + "Home/GetDynamicLookUpData?lookType=Streams&defaultBlank=false",
                    success: function (result) {
        ...
        function GetCompulsorySubjects() {
            return $q(function (resolve, reject) {
                $.ajax({
                    type: 'GET',
                    url: utility.myHost + "Home/GetDynamicLookUpData?lookType=StreamsForApplication&defaultBlank=false",
                    success: function (result) {
                        $scope.StreamSubjects = result;
                        $timeout(function () {
                            //$('#StreamGroup').val($scope.StudentApplication.StreamGroupID);
                            resolve();
                        }, 1000);
        ...
        function GetPreviousClassNames() {
            return $q(function (resolve, reject) {
                $.ajax({
                    type: 'GET',
                    url: utility.myHost + "Home/GetDynamicLookUpData?lookType=PreviousClassNames&defaultBlank=false",
                    success: function (result) {
        ...
        //        $.ajax({
        //            type: 'GET',
        //            url: utility.myHost + "Home/GetDynamicLookUpData?lookType=Classes&defaultBlank=false",
        //            success: function (result) {
        //                $scope.Classes = result;
        //                $timeout(function () {
        //                    $('#ClassKey').val($('#ClassID').val());
        //                    $('#PreviousSchoolClassClassKey').val($('#PreviousSchoolClassCompletedID').val());
        //                    //$('select').formSelect();
        //                    $('#ClassID').val($scope.StudentApplication.ClassKey);
        //                    selectElement("ClassKey", $scope.StudentApplication.ClassKey);
        //                    resolve();
        //                }, 1000);
        //            }
        //        });
        ...
        function GetSyllabus() {
            return $q(function (resolve, reject) {
                $.ajax({
                    type: 'GET',
                    url: utility.myHost + "Home/GetDynamicLookUpData?lookType=Syllabus&defaultBlank=false",
                    success: function (result) {
        ...
        $scope.RelegionChanges = function () {
            ...
            $.ajax({
                ...
                url: utility.myHost + "Home/GetCastByRelegion",
        ...
        $scope.onclassDataChange = function () {
            ...
            if (trimdClassName.match(/Class KG*/)) {
                $scope.EnableSecondLanguage = false;
            }
            else {
                $scope.EnableSecondLanguage = true;
            }
            if (trimdClassName == 'Class 1' || trimdClassName == 'Class 2' || trimdClassName == 'Class 3' || trimdClassName == 'Class 4' || trimdClassName == 'Class 9' || trimdClassName == 'Class 10' || trimdClassName.match(/Class KG*/)) {
                $scope.EnableThirdLanguage = false;
            }
            else {
                $scope.EnableThirdLanguage = true;
            }
        };
        ...
        $scope.StreamGroupChanges = function () {
            ...
            $.ajax({
                ...
                url: utility.myHost + "Home/GetStreamByStreamGroup",
                contentType: "application/json;charset=utf-8",
                success: function (result) {
                    if (!result.IsError && result !== null) {
                        $scope.$apply(function () {
        ...
        //$scope.StreamRadioChanges = function (StreamsID) {
        //    $scope.StreamKey = [];
        //    $scope.StreamKey = StreamsID;
        //    $('.preload-overlay').show();
        //    //var checkBox = document.getElementById("StreamData");
        //    var streamID = StreamsID;
        //    $.ajax({
        //        type: "GET",
        //        data: { streamID: streamID },
        //        url: utility.myHost + "Home/GetStreamCompulsorySubjects",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (result) {
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
        //                    $scope.onStreams_1 = true;
        //                    $scope.StreamSubjects = result.Response;
        //                    $timeout(function () {
        //                    }, 10);
        ...
        //        type: "GET",
        //        data: { streamID: streamID },
        //        url: utility.myHost + "Home/GetStreamOptionalSubjects",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (result) {
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
        //                    $scope.onStreams_1 = true;
        //                    $scope.StreamOPtionalSubjects = result.Response;
        //                    $timeout(function () {
        //                    }, 10);
        ...
        //    else {
        //        $scope.onStreams = false;
        //        $scope.onStreamsGroup = false;
        //        $scope.onStreams_1 = false;
        //    }
        //};


        //$scope.PassOptionalSubjectValues = function () {
        //    $(document).ready(function () {
        //        $scope.OptionalSubjectDat = [];
        //        var $checkes = $('input:checkbox[name="OptionalSubj"]').change(function () {
        //            $scope.OptionalSubjectDat = $checkes.filter(':checked').map(function () {
        //                return this.value;
        //            }).get();
        //            $scope.OptionalSubjects = $scope.OptionalSubjectDat;
        //        });
        //    });
        //};
        ...
        //        url: utility.myHost + "Home/GetClasseByAcademicyear",
        //        contentType: "application/json;charset=utf-8",
        //        success: function (result) {
        //            if (!result.IsError && result !== null) {
        //                $scope.$apply(function () {
        ...
        //                        //$('select').formSelect();
        //                        selectElement("Class", $scope.StudentApplication.ClassID);
        //                    }, 1000);
        ...
        function GetClassesBySchool(schoolID) {
            ...
            return $q(function (resolve, reject) {
                ...
                $.ajax({
                    ...
                    url: utility.myHost + "Home/GetClassesBySchool",
                    contentType: "application/json;charset=utf-8",
                    success: function (result) {
                    ...
                    complete: function (result) {
                        $scope.$apply(function () {
                            $timeout(function () {
                                ...
                                if ($scope.StudentApplication.ClassID == plusOneClassID || $scope.StudentApplication.ClassID == plusTwoClassID) {
                                    $scope.onStreams = true;
                                    GetStreams();
                                    GetCompulsorySubjects();
                                }
        ...
        $scope.SchoolChanges = function () {
            $('.preload-overlay').show();
            var schoolID = $scope.School != null ? $scope.School.Key : null;
            $.ajax({
                type: "GET",
                data: { schoolID: schoolID },
                url: utility.myHost + "Home/GetAcademicYearBySchool",
        ...
        //    }
        //};
        //$scope.TriggerUploadFile = function (uploadedFile, id) {
        //    $scope.uploadedFile = uploadedFile;
        //    $scope.AttachmentName = id;
