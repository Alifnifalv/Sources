...
namespace Eduegate.Web.Library.School.Academics
{
    ...
    public class LessonPlanAttachmentMapViewModel : BaseMasterViewModel
    {
        ...
        [ControlType(Framework.Enums.ControlTypes.Button, "small-col-width", "ng-click='InsertGridRow($index, ModelStructure.LessonPlanAttachments[0], CRUDModel.ViewModel.LessonPlanAttachments)'")]
        [DisplayName("+")]
        public string Add { get; set; }

        [ControlType(Framework.Enums.ControlTypes.Button, "small-col-width", "ng-click='RemoveGridRow($index, ModelStructure.LessonPlanAttachments[0],CRUDModel.ViewModel.LessonPlanAttachments)'")]
        [DisplayName("-")]
