...
namespace Eduegate.Web.Library.School.Academics
{
    ...
    public class LessonPlanTopicMapsViewModel : BaseMasterViewModel
    {
        ...
        [ControlType(Framework.Enums.ControlTypes.Button, "small-col-width", "ng-click='InsertGridRow($index, ModelStructure.LessonPlanTopics[0], CRUDModel.ViewModel.LessonPlanTopics)'")]
        [DisplayName("+")]
        public string Add { get; set; }

        [ControlType(Framework.Enums.ControlTypes.Button, "small-col-width", "ng-click='RemoveGridRow($index, ModelStructure.LessonPlanTopics[0],CRUDModel.ViewModel.LessonPlanTopics)'")]
        [DisplayName("-")]
        public string Remove { get; set; }

        [ControlType(Framework.Enums.ControlTypes.GridGroup, "Task", Attributes4 = "colspan=6")]
        [DisplayName("")]
