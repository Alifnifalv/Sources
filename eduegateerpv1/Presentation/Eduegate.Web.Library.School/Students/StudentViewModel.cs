...
namespace Eduegate.Web.Library.School.Students
{
    ...
    public class StudentViewModel : BaseMasterViewModel
    {
        ...
        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            ...
            vm.SchoolAcademicyear = studentDTO.SchoolAcademicyearID.HasValue ? studentDTO.SchoolAcademicyearID.Value.ToString() : null;
            vm.Academicyear = studentDTO.AcademicYearID.HasValue ? studentDTO.AcademicYear.ToString() : null;
        ...
        public override BaseMasterDTO ToDTO()
        {
            ...
            if (this.StudentLogin.LoginUserID != null)
            {
                dto.Login = new LoginDTO()
                {
                    ...
                    StatusID = !string.IsNullOrEmpty(this.StudentLogin.Status.Key) ? (LoginUserStatus)long.Parse(this.StudentLogin.Status.Key) : (LoginUserStatus?)null,
                };
            }

            if (this.ParentLogin.LoginUserID != null)
            {
                dto.ParentLogin = new LoginDTO()
                {
                    ...
                    (LoginUserStatus)long.Parse(this.ParentLogin.Status.Key) : (LoginUserStatus?)null,
                };
        ...
        public StudentViewModel FromStudentApplicationVM(StudentApplicationViewModel applicationVM)
        {
            ...
            var vm = new StudentViewModel()
            {
                ...
                SchoolAcademicyear = applicationVM.AcademicyearID.HasValue ? applicationVM.AcademicyearID.ToString() : null,
