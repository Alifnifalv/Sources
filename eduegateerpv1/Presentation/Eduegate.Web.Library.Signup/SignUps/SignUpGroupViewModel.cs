...
{
    public class SignUpGroupViewModel : BaseMasterViewModel
    {
        public SignUpGroupViewModel()
        {
        ...
        {
            return JsonConvert.DeserializeObject<SignUpGroupViewModel>(jsonString);
        }

        public override BaseMasterViewModel ToVM(BaseMasterDTO dto)
        {
            Mapper<SignUpGroupDTO, SignUpGroupViewModel>.CreateMap();
            var grpDTO = dto as SignUpGroupDTO;
            var vm = Mapper<SignUpGroupDTO, SignUpGroupViewModel>.Map(dto as SignUpGroupDTO);
        ...
        {
            Mapper<SignUpGroupViewModel, SignUpGroupDTO>.CreateMap();
            var dto = Mapper<SignUpGroupViewModel, SignUpGroupDTO>.Map(this);
