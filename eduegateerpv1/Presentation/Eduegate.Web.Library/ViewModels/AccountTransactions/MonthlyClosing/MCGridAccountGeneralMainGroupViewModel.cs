...
{
    [ContainerType(Framework.Enums.ContainerTypes.Grid, "MCGridAccountGeneralMainGroup", "CRUDModel.ViewModel.MCTabFeeDueGeneral.MCGridAccountGeneralMainGroup")]
    [DisplayName("Account General")]
    public class MCGridAccountGeneralMainGroupViewModel : BaseMasterViewModel 
    {
        public MCGridAccountGeneralMainGroupViewModel()
        {
            MCGridAccountGeneralSubGroup = new List<MCGridAccountGeneralSubGroupViewModel>() { new MCGridAccountGeneralSubGroupViewModel() };
        }
        ...
        [ControlType(Framework.Enums.ControlTypes.GridGroup, "MCGridAccountGeneralSubGroup", Attributes4 = "colspan=9")]
        [DisplayName("")]
        public List<MCGridAccountGeneralSubGroupViewModel> MCGridAccountGeneralSubGroup { get; set; }
    }
}
