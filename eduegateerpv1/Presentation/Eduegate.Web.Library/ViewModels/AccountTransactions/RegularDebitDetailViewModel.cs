...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "RegularDebitTransactionDetails", "CRUDModel.Model.DetailViewModel")]
    public class RegularDebitDetailViewModel : BaseMasterViewModel
    {
        public RegularDebitDetailViewModel()
        {
