...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "PaymentAllocation", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Payment Details")]
    public class PVInvoiceAllocationMasterViewModel : BaseMasterViewModel
    {
