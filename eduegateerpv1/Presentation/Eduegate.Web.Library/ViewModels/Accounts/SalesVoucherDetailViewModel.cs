...
namespace Eduegate.Web.Library.ViewModels.Accounts
{
    ...
    public class SalesVoucherDetailViewModel : BaseMasterViewModel
    {
        public SalesVoucherDetailViewModel()
        {
            Unit = "Hours";
        }
        ...
        [ControlType(Framework.Enums.ControlTypes.TextBox, "ex-large-col-width")]
