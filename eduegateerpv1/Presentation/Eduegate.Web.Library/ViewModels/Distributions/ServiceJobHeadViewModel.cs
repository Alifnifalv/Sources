...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "ServiceJob", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Job Entry")]
    public class ServiceJobHeadViewModel : BaseMasterViewModel
    {
        public ServiceJobHeadViewModel()
        {
        ...
        [DataPicker("Transaction", false, "Transaction")]
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.DropDown)]
        [DisplayName("JobActivity")]
        [LookUp("LookUps.JobActivity")]
