...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "AssetEntryHeadMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Invoice Details")]
    public class AssetEntryHeadMasterViewModel : BaseMasterViewModel
    {
        public AssetEntryHeadMasterViewModel()
        {
        ...
        [Required]
        [ControlType(Framework.Enums.ControlTypes.DropDown, "onecol-header-left", "ng-change='BranchChange($event, $element)'")]
        [DisplayName("Branch")]
        ...
        [Select2("SupplierID", "Numeric", false, "OnChangeSelect2", true)]
