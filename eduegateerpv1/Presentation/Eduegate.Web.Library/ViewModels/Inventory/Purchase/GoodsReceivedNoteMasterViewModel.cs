...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "GoodsReceivedNoteMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Goods Received Note Details")]
    public class GoodsReceivedNoteMasterViewModel : BaseMasterViewModel
    {
        public GoodsReceivedNoteMasterViewModel()
        {
            DocumentReferenceTypeID = Services.Contracts.Enums.DocumentReferenceTypes.GoodsReceivedNotes;
