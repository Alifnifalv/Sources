...
{
    [ContainerType(Framework.Enums.ContainerTypes.Tab, "SalesQuotationMaster", "CRUDModel.Model.MasterViewModel")]
    [DisplayName("Quotation Details")]
    public class SalesQuotationMasterViewModel : BaseMasterViewModel
    {
        public SalesQuotationMasterViewModel()
        {
            ...
            DocumentReferenceTypeID = Services.Contracts.Enums.DocumentReferenceTypes.SalesQuote;
        ...
        [Select2("Store", "String", false, "BranchChange($event, $element)", false, optionalAttribute1: "ng-disabled='CRUDModel.Model.MasterViewModel.TransactionHeadIID !=0'")]
        [DisplayName("Store")]
        ...
        [Select2("Customer", "Numeric", false, "CustomerChange($event, $element); OnChangeSelect2" )]
