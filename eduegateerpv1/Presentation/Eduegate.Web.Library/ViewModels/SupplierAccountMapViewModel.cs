...
namespace Eduegate.Web.Library.ViewModels
{
    ...
    public class SupplierAccountMapViewModel : BaseMasterViewModel
    {
        ...
        public static List<Accounting.SupplierAccountEntitlmentMapsDTO> SaveSupplierAccountMap(SupplierAccountMapViewModel supplierAccountMapViewModel, long SupplierIID, string AccountName_Name, string AccountName_Code)
        {
            ...
            {
                Accounting.SupplierAccountEntitlmentMapsDTO dto = new Accounting.SupplierAccountEntitlmentMapsDTO();
                ...
                Accounting.AccountDTO accountDTO = new Services.Contracts.Accounting.AccountDTO();
                accountDTO.AccountBehavior = (Services.Contracts.Enums.Accounting.AccountBehavior)Convert.ToInt32(viewModel.AccountBehavior);
                accountDTO.AccountGroup = new Accounting.AccountGroupDTO() { AccountGroupID = viewModel.GroupID };
                accountDTO.ParentAccount = new Accounting.AccountDTO { AccountID = viewModel.ParentAccountID };
            ...
            Accounting.SupplierAccountEntitlmentMapsDTO baseEntitlementDto = new Accounting.SupplierAccountEntitlmentMapsDTO();
            ...
            Accounting.AccountDTO baseAccountDTO = new Services.Contracts.Accounting.AccountDTO();
            baseAccountDTO.AccountID = supplierAccountMapViewModel.SupplierAccountId;
            if (baseAccountDTO.ParentAccount == null) baseAccountDTO.ParentAccount = new Accounting.AccountDTO();
        ...
        public static SupplierAccountMapViewModel SetAutoGeneratedAccounts(SupplierAccountMapViewModel supplierAccountMaps, string AccountCode, string AccountNamePrefix, string AccountName_Name, string AccountName_Code)
        {
            ...
            if (supplierAccountMaps.SupplierAccountMapIID == 0)
            {
                ...
                if (baseAccountId != 0)
                {
                    ...
                    Accounting.AccountDTO defaultAccount = AccountsDTOList.FirstOrDefault();
                    List<Accounting.AccountDTO> ChildAccountList = new List<Accounting.AccountDTO>();
                    if (defaultAccount != null)
                    {
                        if (defaultAccount != null)
                        {
                            ...
                            {
                                Accounting.AccountDTO childAccount = new Accounting.AccountDTO();
                                ...
                                childAccount.AccountBehavior = (Services.Contracts.Enums.Accounting.AccountBehavior)defaultAccount.AccountBehavior;
                                childAccount.AccountGroup = new Accounting.AccountGroupDTO() { AccountGroupID = defaultAccount.AccountGroup.AccountGroupID };
                            ...
                            Accounting.AccountDTO BaseAccount = new Accounting.AccountDTO();
                            BaseAccount.AccountID = 0;
                            BaseAccount.ParentAccount = new Accounting.AccountDTO() { AccountID = defaultAccount.AccountID };
                    ...
                    if (ChildAccountList != null)
                    {
                        ...
                        {
                            Accounting.AccountDTO account = ChildAccountList[nLoopIndex];
        ...
        public static SupplierAccountMapViewModel
            SetSupplierAccountMapsViewModel(Eduegate.Services.Contracts.Accounting.SupplierAccountMapDTO dto, EntityTypes SupplierCustomer)
        {
            ...
            foreach (Eduegate.Services.Contracts.Accounting.SupplierAccountEntitlmentMapsDTO item in dto.SupplierAccountEntitlements)
            {
