...
namespace Eduegate.Public.Api.Controllers
{
    ...
    public class SchoolController : ApiControllerBase
    {
        ...
        public List<AssignmentDTO> GetAssignments(long studentID)
        {
            return new SchoolService(CallContext).GetAssignments(studentID);
        }
        ...
        public List<NotificationAlertsDTO> GetMyNotification()
        {
            return new SchoolService(CallContext).GetMyNotification();
        }
        ...
        [HttpGet]
        [Route("GetSchoolPrincipalOrHeadMistress")]

        public KeyValueDTO GetSchoolPrincipalOrHeadMistress(byte schoolID)
        {
            return new SchoolService(CallContext).GetSchoolPrincipalOrHeadMistress(schoolID);

        }

        [HttpGet]
        [Route("GetSchoolWisePrincipal")]
        public KeyValueDTO GetSchoolWisePrincipal(byte schoolID)
        {
            return new SchoolService(CallContext).GetSchoolWisePrincipal(schoolID);

        }

        [HttpGet]
        [Route("GetClassHeadTeacher")]
        ...
        //public ActionResult GenerateTicket(TicketDTO ticket)
        //{
        ...
        //        Action = feeActionID,
        //        Status = newStatusID,
        //        DueDateFromString = currentDate.Date.ToString(dateFormat, CultureInfo.InvariantCulture),
        ...
        //    if (crudSave.IsError)
        //    {
        //        return Ok(new { IsError = true, Response = crudSave.ErrorMessage });
        //    }
        //    else
        //    {
        //        return Ok(new { IsError = false, Response = "Ticket generated successfully." });
        //    }
