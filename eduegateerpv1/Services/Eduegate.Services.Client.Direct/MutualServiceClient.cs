...
namespace Eduegate.Service.Client.Direct
{
    public class MutualServiceClient : IMutualService
    {
        ...
        public List<CommentDTO> GetChats(Eduegate.Infrastructure.Enums.EntityTypes entityTypeID, long ReferenceID, long? fromLoginID, long? toLoginID, long departmentID = 0)
        {
            return service.GetChats(entityTypeID, fromLoginID, toLoginID);
        }
