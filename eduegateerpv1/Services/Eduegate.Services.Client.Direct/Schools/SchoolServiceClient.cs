...
namespace Eduegate.Services.Client.Direct.Schools
{
    public class SchoolServiceClient : BaseClient, ISchoolService
    {
        ...
        {
            return ((ISchoolService)service).GetNotificationAlerts(loginID);
        }
        ...
        {
            return service.GetAcademicYearBySchool(schoolID);
        }

        public List<KeyValueDTO> GetClasseByAcademicyear(int academicyearID)
        {
            return service.GetClasseByAcademicyear(academicyearID);
        }
        ...
        {
            return service.GetStudentDetailsByParent(parentID);
        }
