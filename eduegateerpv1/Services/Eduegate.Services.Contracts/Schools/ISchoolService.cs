...
namespace Eduegate.Services.Contracts.Schools
{
    public interface ISchoolService
    {
        ...
        List<TimeTableAllocInfoHeaderDTO> GetSmartTimeTableByDate(int tableMasterId, DateTime timeTableDate);

        List<TimeTableListDTO> GetTeacherSummary();

        List<TimeTableListDTO> GetClassSummary();

        List<TimeTableAllocationDTO> GetClassSectionTimeTableSummary();

        List<TimeTableListDTO> GetTeacherSummaryByTeacherID(long employeeID);

        List<TimeTableListDTO> GetClassSummaryDetails(long classID, long sectionID);
    }
}