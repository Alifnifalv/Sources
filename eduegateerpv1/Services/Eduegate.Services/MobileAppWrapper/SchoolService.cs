    ...
    public class SchoolService : BaseService, ISchoolService
    {
        ...
        public List<AssignmentDTO> GetAssignments(long studentID)
        {
            return AssignmentMapper
                .Mapper(CallContext)
                .GetAssignmentStudentwise(studentID, null);
        }
        ...
        {
            return NotificationAlertMapper.Mapper(CallContext)
                .GetNotificationAlerts(CallContext.LoginID.Value);
        }
        ...
        public AppVersionDTO CheckAppVersion(string currentAppVersion, string appID)
        {
            ...
            if (!string.IsNullOrEmpty(currentAppVersion))
            {
                ...
                var forceUpdateVersion = new SettingBL(null).GetSettingValue<string>("FORCE_UPDATE_MIN_VERSION");
