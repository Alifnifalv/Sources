...
namespace Eduegate.Services.Schools
{
    public class SchoolService : BaseService, ISchoolService
    {
        ...
        public void DeleteTimeTableEntry(string timeTableAllocationID)
        {
            TimeTableAllocationMapper.Mapper(CallContext).DeleteEntity(timeTableAllocationID);
        }
        ...
        {
            return NotificationAlertMapper.Mapper(CallContext).GetNotificationAlerts(loginID);
        }
        ...
        {
            return StudentApplicationMapper.Mapper(CallContext).GetAcademicYearBySchool(schoolID);
        }

        public List<KeyValueDTO> GetClasseByAcademicyear(int academicyearID)
        {
            return StudentApplicationMapper.Mapper(CallContext).GetClasseByAcademicyear(academicyearID);
        }
        ...
        {
            return StudentConcessionMapper.Mapper(CallContext).GetStudentDetailsByParent(parentID);
        }
        ...
        {
            return TimeTableLogMapper.Mapper(CallContext).GetSmartTimeTableByDate(tableMasterId, timeTableDate);
        }

        public List<TimeTableListDTO> GetTeacherSummary()
        {
            return TimeTableLogMapper.Mapper(CallContext).GetTeacherSummary();
        }

        public List<TimeTableListDTO> GetClassSummary()
        {
            return TimeTableLogMapper.Mapper(CallContext).GetClassSummary();
        }

        public List<TimeTableAllocationDTO> GetClassSectionTimeTableSummary()
        {
            return TimeTableLogMapper.Mapper(CallContext).GetClassSectionTimeTableSummary();
        }

        public List<TimeTableListDTO> GetTeacherSummaryByTeacherID(long employeeID)
        {
            return TimeTableLogMapper.Mapper(CallContext).GetTeacherSummaryByTeacherID(employeeID);
        }

        public List<TimeTableListDTO> GetClassSummaryDetails(long classID, long sectionID)
        {
            return TimeTableLogMapper.Mapper(CallContext).GetClassSummaryDetails(classID,sectionID);
        }
    }
}