...
{
    public class CategoryPriceSettingSearchViewMap : EntityTypeConfiguration<CategoryPriceSettingSearchView>
    {
        public CategoryPriceSettingSearchViewMap()
        {
            // Primary Key
            ...
            this.ToTable("CategoryPriceSettingSearchView", "catalog");
