...
{
    public class ProductSearchViewMap : EntityTypeConfiguration<ProductSearchView>
    {
        public ProductSearchViewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ProductIID, t.PartNumber, t.ProductCode, t.ProductTypeName });
            ...
            this.ToTable("ProductSearchView", "catalog");
