...
{
    public class ProductSettingSummaryViewMap : EntityTypeConfiguration<ProductSettingSummaryView>
    {
        public ProductSettingSummaryViewMap()
        {
            // Primary Key
            ...
            this.ToTable("ProductSettingSummaryView", "catalog");
